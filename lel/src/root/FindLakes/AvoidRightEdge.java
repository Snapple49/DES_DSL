...
public class AvoidRightEdge implements Behavior{
	...
	public AvoidRightEdge(FindLakes par,
	...
	public boolean takeControl() {
		return (sensorManager.getRightLight() > sensorManager.rightWhiteThreshold);
	}
	...
	public void action() {
		...
		AuxMethods.turnDegrees(false, 300, leftMotor, rightMotor);
		break;
		}
	}
