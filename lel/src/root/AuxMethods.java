...
public class AuxMethods {
	...
	static public void resetAll(EV3LargeRegulatedMotor lMtr, EV3LargeRegulatedMotor rMtr, EV3MediumRegulatedMotor aMtr,
			Mission mis) {
		lMtr.stop(true);
		rMtr.stop(true);
		aMtr.stop(true);
	...
	static public void centralize(SensorManager sMgr, EV3LargeRegulatedMotor lMtr, EV3LargeRegulatedMotor rMtr) {
		...
		while (!(sMgr.getLeftLight() < sMgr.leftBlackThreshold && sMgr.getRightLight() < sMgr.rightBlackThreshold
				&& sMgr.getColor() != Color.BLACK)) {
