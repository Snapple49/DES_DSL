...
public class SampleRedLake implements Behavior{
	...
	public SampleRedLake(FindLakes par,
	...
	public boolean takeControl() {
		return (sensorManager.getColor() == Color.RED && !(parent.RedFound));
	}
