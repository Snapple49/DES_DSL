		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getTriggerAccess().getGroup_1_1_1_3(), "rule__Trigger__Group_1_1_1_3__0");
					...
					put(grammarAccess.getTriggerAccess().getTouchingAssignment_1_1_1_2(), "rule__Trigger__TouchingAssignment_1_1_1_2");
					put(grammarAccess.getTriggerAccess().getDegreesAssignment_1_1_1_3_1(), "rule__Trigger__DegreesAssignment_1_1_1_3_1");
