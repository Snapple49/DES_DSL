...
public class InternalRobotDSLParser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'forward'", "'backward'", "'left'", "'right'", "'high'", "'medium'", "'low'", "'raise'", "'lower'", "'buzz'", "'fanfare'", "'Color'", "'LeftLight'", "'RightLight'", "'RearHeight'", "'FrontDistance'", "'LeftTouch'", "'RightTouch'", "'Gyro'", "'red'", "'white'", "'black'", "'green'", "'blue'", "'less'", "'greater'", "'and'", "'or'", "'true'", "'false'", "'Missionset'", "'Missions:'", "'Mission'", "'Flags:'", "'Tasks:'", "'Goal:'", "'Condition:'", "'Actions:'", "'Task:'", "'priority:'", "'Triggers:'", "'Move'", "'for'", "'millisec'", "'at'", "'speed'", "'Turn'", "'deg'", "'until'", "'Arm'", "'Play'", "'sound'", "'Update'", "'to'", "'is'", "'distance'", "'spun'", "'than'", "'cm'", "'Time:'", "'sec'", "'Centalize'", "'touching'", "'not'"
    };
    ...
    // InternalRobotDSL.g:676:1: rule__Trigger__Alternatives_1_1_1 : ( ( ( rule__Trigger__Group_1_1_1_0__0 ) ) | ( ( rule__Trigger__Group_1_1_1_1__0 ) ) | ( ( rule__Trigger__TouchingAssignment_1_1_1_2 ) ) | ( ( rule__Trigger__Group_1_1_1_3__0 ) ) );
    public final void rule__Trigger__Alternatives_1_1_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:680:1: ( ( ( rule__Trigger__Group_1_1_1_0__0 ) ) | ( ( rule__Trigger__Group_1_1_1_1__0 ) ) | ( ( rule__Trigger__TouchingAssignment_1_1_1_2 ) ) | ( ( rule__Trigger__Group_1_1_1_3__0 ) ) )
            int alt4=4;
            switch ( input.LA(1) ) {
            case 65:
                {
            ...
            switch (alt4) {
                ...
                case 2 :
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:693:2: ( ( rule__Trigger__TouchingAssignment_1_1_1_2 ) )
                    {
                    // InternalRobotDSL.g:693:2: ( ( rule__Trigger__TouchingAssignment_1_1_1_2 ) )
                    // InternalRobotDSL.g:694:3: ( rule__Trigger__TouchingAssignment_1_1_1_2 )
                    {
                     before(grammarAccess.getTriggerAccess().getTouchingAssignment_1_1_1_2()); 
                    // InternalRobotDSL.g:695:3: ( rule__Trigger__TouchingAssignment_1_1_1_2 )
                    // InternalRobotDSL.g:695:4: rule__Trigger__TouchingAssignment_1_1_1_2
                    {
                    pushFollow(FOLLOW_2);
                    rule__Trigger__TouchingAssignment_1_1_1_2();
                    ...
                    state._fsp--;
                     ...
                     after(grammarAccess.getTriggerAccess().getTouchingAssignment_1_1_1_2()); 
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:699:2: ( ( rule__Trigger__Group_1_1_1_3__0 ) )
                    {
                    // InternalRobotDSL.g:699:2: ( ( rule__Trigger__Group_1_1_1_3__0 ) )
                    // InternalRobotDSL.g:700:3: ( rule__Trigger__Group_1_1_1_3__0 )
                    {
                     before(grammarAccess.getTriggerAccess().getGroup_1_1_1_3()); 
                    // InternalRobotDSL.g:701:3: ( rule__Trigger__Group_1_1_1_3__0 )
                    // InternalRobotDSL.g:701:4: rule__Trigger__Group_1_1_1_3__0
                    {
                    pushFollow(FOLLOW_2);
                    rule__Trigger__Group_1_1_1_3__0();
                    ...
                    state._fsp--;
                     ...
                     after(grammarAccess.getTriggerAccess().getGroup_1_1_1_3()); 
    ...
    // InternalRobotDSL.g:709:1: rule__DirectionVal__Alternatives : ( ( ( 'forward' ) ) | ( ( 'backward' ) ) | ( ( 'left' ) ) | ( ( 'right' ) ) );
    public final void rule__DirectionVal__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:713:1: ( ( ( 'forward' ) ) | ( ( 'backward' ) ) | ( ( 'left' ) ) | ( ( 'right' ) ) )
            int alt5=4;
            switch ( input.LA(1) ) {
            case 11:
                {
            ...
            switch (alt5) {
                case 1 :
                    // InternalRobotDSL.g:714:2: ( ( 'forward' ) )
                    {
                    // InternalRobotDSL.g:714:2: ( ( 'forward' ) )
                    // InternalRobotDSL.g:715:3: ( 'forward' )
                    {
                     before(grammarAccess.getDirectionValAccess().getFORWARDEnumLiteralDeclaration_0()); 
                    // InternalRobotDSL.g:716:3: ( 'forward' )
                    // InternalRobotDSL.g:716:4: 'forward'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:720:2: ( ( 'backward' ) )
                    {
                    // InternalRobotDSL.g:720:2: ( ( 'backward' ) )
                    // InternalRobotDSL.g:721:3: ( 'backward' )
                    {
                     before(grammarAccess.getDirectionValAccess().getBACKWARDEnumLiteralDeclaration_1()); 
                    // InternalRobotDSL.g:722:3: ( 'backward' )
                    // InternalRobotDSL.g:722:4: 'backward'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:726:2: ( ( 'left' ) )
                    {
                    // InternalRobotDSL.g:726:2: ( ( 'left' ) )
                    // InternalRobotDSL.g:727:3: ( 'left' )
                    {
                     before(grammarAccess.getDirectionValAccess().getLEFTEnumLiteralDeclaration_2()); 
                    // InternalRobotDSL.g:728:3: ( 'left' )
                    // InternalRobotDSL.g:728:4: 'left'
                    {
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:732:2: ( ( 'right' ) )
                    {
                    // InternalRobotDSL.g:732:2: ( ( 'right' ) )
                    // InternalRobotDSL.g:733:3: ( 'right' )
                    {
                     before(grammarAccess.getDirectionValAccess().getRIGHTEnumLiteralDeclaration_3()); 
                    // InternalRobotDSL.g:734:3: ( 'right' )
                    // InternalRobotDSL.g:734:4: 'right'
                    {
    ...
    // InternalRobotDSL.g:742:1: rule__SpeedVal__Alternatives : ( ( ( 'high' ) ) | ( ( 'medium' ) ) | ( ( 'low' ) ) );
    public final void rule__SpeedVal__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:746:1: ( ( ( 'high' ) ) | ( ( 'medium' ) ) | ( ( 'low' ) ) )
            int alt6=3;
            switch ( input.LA(1) ) {
            case 15:
                {
            ...
            switch (alt6) {
                case 1 :
                    // InternalRobotDSL.g:747:2: ( ( 'high' ) )
                    {
                    // InternalRobotDSL.g:747:2: ( ( 'high' ) )
                    // InternalRobotDSL.g:748:3: ( 'high' )
                    {
                     before(grammarAccess.getSpeedValAccess().getHIGHEnumLiteralDeclaration_0()); 
                    // InternalRobotDSL.g:749:3: ( 'high' )
                    // InternalRobotDSL.g:749:4: 'high'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:753:2: ( ( 'medium' ) )
                    {
                    // InternalRobotDSL.g:753:2: ( ( 'medium' ) )
                    // InternalRobotDSL.g:754:3: ( 'medium' )
                    {
                     before(grammarAccess.getSpeedValAccess().getMEDEnumLiteralDeclaration_1()); 
                    // InternalRobotDSL.g:755:3: ( 'medium' )
                    // InternalRobotDSL.g:755:4: 'medium'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:759:2: ( ( 'low' ) )
                    {
                    // InternalRobotDSL.g:759:2: ( ( 'low' ) )
                    // InternalRobotDSL.g:760:3: ( 'low' )
                    {
                     before(grammarAccess.getSpeedValAccess().getLOWEnumLiteralDeclaration_2()); 
                    // InternalRobotDSL.g:761:3: ( 'low' )
                    // InternalRobotDSL.g:761:4: 'low'
                    {
    ...
    // InternalRobotDSL.g:769:1: rule__ArmOpType__Alternatives : ( ( ( 'raise' ) ) | ( ( 'lower' ) ) );
    public final void rule__ArmOpType__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:773:1: ( ( ( 'raise' ) ) | ( ( 'lower' ) ) )
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalRobotDSL.g:774:2: ( ( 'raise' ) )
                    {
                    // InternalRobotDSL.g:774:2: ( ( 'raise' ) )
                    // InternalRobotDSL.g:775:3: ( 'raise' )
                    {
                     before(grammarAccess.getArmOpTypeAccess().getUPEnumLiteralDeclaration_0()); 
                    // InternalRobotDSL.g:776:3: ( 'raise' )
                    // InternalRobotDSL.g:776:4: 'raise'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:780:2: ( ( 'lower' ) )
                    {
                    // InternalRobotDSL.g:780:2: ( ( 'lower' ) )
                    // InternalRobotDSL.g:781:3: ( 'lower' )
                    {
                     before(grammarAccess.getArmOpTypeAccess().getDOWNEnumLiteralDeclaration_1()); 
                    // InternalRobotDSL.g:782:3: ( 'lower' )
                    // InternalRobotDSL.g:782:4: 'lower'
                    {
    ...
    // InternalRobotDSL.g:790:1: rule__SoundName__Alternatives : ( ( ( 'buzz' ) ) | ( ( 'fanfare' ) ) );
    public final void rule__SoundName__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:794:1: ( ( ( 'buzz' ) ) | ( ( 'fanfare' ) ) )
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalRobotDSL.g:795:2: ( ( 'buzz' ) )
                    {
                    // InternalRobotDSL.g:795:2: ( ( 'buzz' ) )
                    // InternalRobotDSL.g:796:3: ( 'buzz' )
                    {
                     before(grammarAccess.getSoundNameAccess().getBUZZEnumLiteralDeclaration_0()); 
                    // InternalRobotDSL.g:797:3: ( 'buzz' )
                    // InternalRobotDSL.g:797:4: 'buzz'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:801:2: ( ( 'fanfare' ) )
                    {
                    // InternalRobotDSL.g:801:2: ( ( 'fanfare' ) )
                    // InternalRobotDSL.g:802:3: ( 'fanfare' )
                    {
                     before(grammarAccess.getSoundNameAccess().getFANFAREEnumLiteralDeclaration_1()); 
                    // InternalRobotDSL.g:803:3: ( 'fanfare' )
                    // InternalRobotDSL.g:803:4: 'fanfare'
                    {
    ...
    // InternalRobotDSL.g:811:1: rule__SensorType__Alternatives : ( ( ( 'Color' ) ) | ( ( 'LeftLight' ) ) | ( ( 'RightLight' ) ) | ( ( 'RearHeight' ) ) | ( ( 'FrontDistance' ) ) | ( ( 'LeftTouch' ) ) | ( ( 'RightTouch' ) ) | ( ( 'Gyro' ) ) );
    public final void rule__SensorType__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:815:1: ( ( ( 'Color' ) ) | ( ( 'LeftLight' ) ) | ( ( 'RightLight' ) ) | ( ( 'RearHeight' ) ) | ( ( 'FrontDistance' ) ) | ( ( 'LeftTouch' ) ) | ( ( 'RightTouch' ) ) | ( ( 'Gyro' ) ) )
            int alt9=8;
            switch ( input.LA(1) ) {
            case 22:
                {
            ...
            switch (alt9) {
                case 1 :
                    // InternalRobotDSL.g:816:2: ( ( 'Color' ) )
                    {
                    // InternalRobotDSL.g:816:2: ( ( 'Color' ) )
                    // InternalRobotDSL.g:817:3: ( 'Color' )
                    {
                     before(grammarAccess.getSensorTypeAccess().getCOLOREnumLiteralDeclaration_0()); 
                    // InternalRobotDSL.g:818:3: ( 'Color' )
                    // InternalRobotDSL.g:818:4: 'Color'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:822:2: ( ( 'LeftLight' ) )
                    {
                    // InternalRobotDSL.g:822:2: ( ( 'LeftLight' ) )
                    // InternalRobotDSL.g:823:3: ( 'LeftLight' )
                    {
                     before(grammarAccess.getSensorTypeAccess().getLEFTLIGHTEnumLiteralDeclaration_1()); 
                    // InternalRobotDSL.g:824:3: ( 'LeftLight' )
                    // InternalRobotDSL.g:824:4: 'LeftLight'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:828:2: ( ( 'RightLight' ) )
                    {
                    // InternalRobotDSL.g:828:2: ( ( 'RightLight' ) )
                    // InternalRobotDSL.g:829:3: ( 'RightLight' )
                    {
                     before(grammarAccess.getSensorTypeAccess().getRIGHTLIGHTEnumLiteralDeclaration_2()); 
                    // InternalRobotDSL.g:830:3: ( 'RightLight' )
                    // InternalRobotDSL.g:830:4: 'RightLight'
                    {
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:834:2: ( ( 'RearHeight' ) )
                    {
                    // InternalRobotDSL.g:834:2: ( ( 'RearHeight' ) )
                    // InternalRobotDSL.g:835:3: ( 'RearHeight' )
                    {
                     before(grammarAccess.getSensorTypeAccess().getBACKUSEnumLiteralDeclaration_3()); 
                    // InternalRobotDSL.g:836:3: ( 'RearHeight' )
                    // InternalRobotDSL.g:836:4: 'RearHeight'
                    {
                    ...
                    break;
                case 5 :
                    // InternalRobotDSL.g:840:2: ( ( 'FrontDistance' ) )
                    {
                    // InternalRobotDSL.g:840:2: ( ( 'FrontDistance' ) )
                    // InternalRobotDSL.g:841:3: ( 'FrontDistance' )
                    {
                     before(grammarAccess.getSensorTypeAccess().getFRONTUSEnumLiteralDeclaration_4()); 
                    // InternalRobotDSL.g:842:3: ( 'FrontDistance' )
                    // InternalRobotDSL.g:842:4: 'FrontDistance'
                    {
                    ...
                    break;
                case 6 :
                    // InternalRobotDSL.g:846:2: ( ( 'LeftTouch' ) )
                    {
                    // InternalRobotDSL.g:846:2: ( ( 'LeftTouch' ) )
                    // InternalRobotDSL.g:847:3: ( 'LeftTouch' )
                    {
                     before(grammarAccess.getSensorTypeAccess().getLEFTTOUCHEnumLiteralDeclaration_5()); 
                    // InternalRobotDSL.g:848:3: ( 'LeftTouch' )
                    // InternalRobotDSL.g:848:4: 'LeftTouch'
                    {
                    ...
                    break;
                case 7 :
                    // InternalRobotDSL.g:852:2: ( ( 'RightTouch' ) )
                    {
                    // InternalRobotDSL.g:852:2: ( ( 'RightTouch' ) )
                    // InternalRobotDSL.g:853:3: ( 'RightTouch' )
                    {
                     before(grammarAccess.getSensorTypeAccess().getRIGHTTOUCHEnumLiteralDeclaration_6()); 
                    // InternalRobotDSL.g:854:3: ( 'RightTouch' )
                    // InternalRobotDSL.g:854:4: 'RightTouch'
                    {
                    ...
                    break;
                case 8 :
                    // InternalRobotDSL.g:858:2: ( ( 'Gyro' ) )
                    {
                    // InternalRobotDSL.g:858:2: ( ( 'Gyro' ) )
                    // InternalRobotDSL.g:859:3: ( 'Gyro' )
                    {
                     before(grammarAccess.getSensorTypeAccess().getGYROEnumLiteralDeclaration_7()); 
                    // InternalRobotDSL.g:860:3: ( 'Gyro' )
                    // InternalRobotDSL.g:860:4: 'Gyro'
                    {
    ...
    // InternalRobotDSL.g:868:1: rule__ColorName__Alternatives : ( ( ( 'red' ) ) | ( ( 'white' ) ) | ( ( 'black' ) ) | ( ( 'green' ) ) | ( ( 'blue' ) ) );
    public final void rule__ColorName__Alternatives() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:872:1: ( ( ( 'red' ) ) | ( ( 'white' ) ) | ( ( 'black' ) ) | ( ( 'green' ) ) | ( ( 'blue' ) ) )
            int alt10=5;
            switch ( input.LA(1) ) {
            case 30:
                {
            ...
            switch (alt10) {
                case 1 :
                    // InternalRobotDSL.g:873:2: ( ( 'red' ) )
                    {
                    // InternalRobotDSL.g:873:2: ( ( 'red' ) )
                    // InternalRobotDSL.g:874:3: ( 'red' )
                    {
                     before(grammarAccess.getColorNameAccess().getREDEnumLiteralDeclaration_0()); 
                    // InternalRobotDSL.g:875:3: ( 'red' )
                    // InternalRobotDSL.g:875:4: 'red'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:879:2: ( ( 'white' ) )
                    {
                    // InternalRobotDSL.g:879:2: ( ( 'white' ) )
                    // InternalRobotDSL.g:880:3: ( 'white' )
                    {
                     before(grammarAccess.getColorNameAccess().getWHITEEnumLiteralDeclaration_1()); 
                    // InternalRobotDSL.g:881:3: ( 'white' )
                    // InternalRobotDSL.g:881:4: 'white'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:885:2: ( ( 'black' ) )
                    {
                    // InternalRobotDSL.g:885:2: ( ( 'black' ) )
                    // InternalRobotDSL.g:886:3: ( 'black' )
                    {
                     before(grammarAccess.getColorNameAccess().getBLACKEnumLiteralDeclaration_2()); 
                    // InternalRobotDSL.g:887:3: ( 'black' )
                    // InternalRobotDSL.g:887:4: 'black'
                    {
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:891:2: ( ( 'green' ) )
                    {
                    // InternalRobotDSL.g:891:2: ( ( 'green' ) )
                    // InternalRobotDSL.g:892:3: ( 'green' )
                    {
                     before(grammarAccess.getColorNameAccess().getGREENEnumLiteralDeclaration_3()); 
                    // InternalRobotDSL.g:893:3: ( 'green' )
                    // InternalRobotDSL.g:893:4: 'green'
                    {
                    ...
                    break;
                case 5 :
                    // InternalRobotDSL.g:897:2: ( ( 'blue' ) )
                    {
                    // InternalRobotDSL.g:897:2: ( ( 'blue' ) )
                    // InternalRobotDSL.g:898:3: ( 'blue' )
                    {
                     before(grammarAccess.getColorNameAccess().getBLUEEnumLiteralDeclaration_4()); 
                    // InternalRobotDSL.g:899:3: ( 'blue' )
                    // InternalRobotDSL.g:899:4: 'blue'
                    {
    ...
    public final void rule__Goal__Group_0__1__Impl() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( (LA18_0==RULE_ID||(LA18_0>=22 && LA18_0<=29)||(LA18_0>=35 && LA18_0<=40)||LA18_0==74) ) {
                    alt18=1;
                }
    ...
    public final void rule__Task__Group_4__1__Impl() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( (LA22_0==RULE_ID||(LA22_0>=22 && LA22_0<=29)||(LA22_0>=35 && LA22_0<=40)||LA22_0==74) ) {
                    alt22=1;
                }
    ...
    // InternalRobotDSL.g:1923:1: rule__Action__Group_0_2__2__Impl : ( 'millisec' ) ;
    public final void rule__Action__Group_0_2__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:1927:1: ( ( 'millisec' ) )
            // InternalRobotDSL.g:1928:1: ( 'millisec' )
            {
            // InternalRobotDSL.g:1928:1: ( 'millisec' )
            // InternalRobotDSL.g:1929:2: 'millisec'
            {
    ...
    public final void rule__Action__Group_1_2_1__1__Impl() throws RecognitionException {
        ...
        try {
            ...
            do {
                ...
                if ( (LA25_0==RULE_ID||(LA25_0>=22 && LA25_0<=29)||(LA25_0>=35 && LA25_0<=40)||LA25_0==74) ) {
                    alt25=1;
                }
    ...
    // $ANTLR start "rule__Trigger__Group_1_1_1_3__0"
    // InternalRobotDSL.g:2729:1: rule__Trigger__Group_1_1_1_3__0 : rule__Trigger__Group_1_1_1_3__0__Impl rule__Trigger__Group_1_1_1_3__1 ;
    public final void rule__Trigger__Group_1_1_1_3__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2733:1: ( rule__Trigger__Group_1_1_1_3__0__Impl rule__Trigger__Group_1_1_1_3__1 )
            // InternalRobotDSL.g:2734:2: rule__Trigger__Group_1_1_1_3__0__Impl rule__Trigger__Group_1_1_1_3__1
            {
            pushFollow(FOLLOW_19);
            rule__Trigger__Group_1_1_1_3__0__Impl();

            state._fsp--;

            pushFollow(FOLLOW_2);
            rule__Trigger__Group_1_1_1_3__1();
    ...
    // $ANTLR end "rule__Trigger__Group_1_1_1_3__0"


    // $ANTLR start "rule__Trigger__Group_1_1_1_3__0__Impl"
    // InternalRobotDSL.g:2741:1: rule__Trigger__Group_1_1_1_3__0__Impl : ( 'spun' ) ;
    public final void rule__Trigger__Group_1_1_1_3__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2745:1: ( ( 'spun' ) )
            // InternalRobotDSL.g:2746:1: ( 'spun' )
            {
            // InternalRobotDSL.g:2746:1: ( 'spun' )
            // InternalRobotDSL.g:2747:2: 'spun'
            {
             before(grammarAccess.getTriggerAccess().getSpunKeyword_1_1_1_3_0()); 
            match(input,67,FOLLOW_2); 
             after(grammarAccess.getTriggerAccess().getSpunKeyword_1_1_1_3_0()); 
    ...
    // $ANTLR end "rule__Trigger__Group_1_1_1_3__0__Impl"


    // $ANTLR start "rule__Trigger__Group_1_1_1_3__1"
    // InternalRobotDSL.g:2756:1: rule__Trigger__Group_1_1_1_3__1 : rule__Trigger__Group_1_1_1_3__1__Impl ;
    public final void rule__Trigger__Group_1_1_1_3__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2760:1: ( rule__Trigger__Group_1_1_1_3__1__Impl )
            // InternalRobotDSL.g:2761:2: rule__Trigger__Group_1_1_1_3__1__Impl
            {
            pushFollow(FOLLOW_2);
            rule__Trigger__Group_1_1_1_3__1__Impl();
    ...
    // $ANTLR end "rule__Trigger__Group_1_1_1_3__1"


    // $ANTLR start "rule__Trigger__Group_1_1_1_3__1__Impl"
    // InternalRobotDSL.g:2767:1: rule__Trigger__Group_1_1_1_3__1__Impl : ( ( rule__Trigger__DegreesAssignment_1_1_1_3_1 ) ) ;
    public final void rule__Trigger__Group_1_1_1_3__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2771:1: ( ( ( rule__Trigger__DegreesAssignment_1_1_1_3_1 ) ) )
            // InternalRobotDSL.g:2772:1: ( ( rule__Trigger__DegreesAssignment_1_1_1_3_1 ) )
            {
            // InternalRobotDSL.g:2772:1: ( ( rule__Trigger__DegreesAssignment_1_1_1_3_1 ) )
            // InternalRobotDSL.g:2773:2: ( rule__Trigger__DegreesAssignment_1_1_1_3_1 )
            {
             before(grammarAccess.getTriggerAccess().getDegreesAssignment_1_1_1_3_1()); 
            // InternalRobotDSL.g:2774:2: ( rule__Trigger__DegreesAssignment_1_1_1_3_1 )
            // InternalRobotDSL.g:2774:3: rule__Trigger__DegreesAssignment_1_1_1_3_1
            {
            pushFollow(FOLLOW_2);
            rule__Trigger__DegreesAssignment_1_1_1_3_1();
            ...
            state._fsp--;
             ...
             after(grammarAccess.getTriggerAccess().getDegreesAssignment_1_1_1_3_1()); 
    ...
    // $ANTLR end "rule__Trigger__Group_1_1_1_3__1__Impl"


    // $ANTLR start "rule__Distance__Group__0"
    // InternalRobotDSL.g:2783:1: rule__Distance__Group__0 : rule__Distance__Group__0__Impl rule__Distance__Group__1 ;
    public final void rule__Distance__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2787:1: ( rule__Distance__Group__0__Impl rule__Distance__Group__1 )
            // InternalRobotDSL.g:2788:2: rule__Distance__Group__0__Impl rule__Distance__Group__1
            {
    ...
    // InternalRobotDSL.g:2795:1: rule__Distance__Group__0__Impl : ( ( rule__Distance__RangeBoolAssignment_0 ) ) ;
    public final void rule__Distance__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2799:1: ( ( ( rule__Distance__RangeBoolAssignment_0 ) ) )
            // InternalRobotDSL.g:2800:1: ( ( rule__Distance__RangeBoolAssignment_0 ) )
            {
            // InternalRobotDSL.g:2800:1: ( ( rule__Distance__RangeBoolAssignment_0 ) )
            // InternalRobotDSL.g:2801:2: ( rule__Distance__RangeBoolAssignment_0 )
            {
             before(grammarAccess.getDistanceAccess().getRangeBoolAssignment_0()); 
            // InternalRobotDSL.g:2802:2: ( rule__Distance__RangeBoolAssignment_0 )
            // InternalRobotDSL.g:2802:3: rule__Distance__RangeBoolAssignment_0
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalRobotDSL.g:2810:1: rule__Distance__Group__1 : rule__Distance__Group__1__Impl rule__Distance__Group__2 ;
    public final void rule__Distance__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2814:1: ( rule__Distance__Group__1__Impl rule__Distance__Group__2 )
            // InternalRobotDSL.g:2815:2: rule__Distance__Group__1__Impl rule__Distance__Group__2
            {
            pushFollow(FOLLOW_19);
    ...
    // InternalRobotDSL.g:2822:1: rule__Distance__Group__1__Impl : ( 'than' ) ;
    public final void rule__Distance__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2826:1: ( ( 'than' ) )
            // InternalRobotDSL.g:2827:1: ( 'than' )
            {
            // InternalRobotDSL.g:2827:1: ( 'than' )
            // InternalRobotDSL.g:2828:2: 'than'
            {
    ...
    // InternalRobotDSL.g:2837:1: rule__Distance__Group__2 : rule__Distance__Group__2__Impl rule__Distance__Group__3 ;
    public final void rule__Distance__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2841:1: ( rule__Distance__Group__2__Impl rule__Distance__Group__3 )
            // InternalRobotDSL.g:2842:2: rule__Distance__Group__2__Impl rule__Distance__Group__3
            {
    ...
    // InternalRobotDSL.g:2849:1: rule__Distance__Group__2__Impl : ( ( rule__Distance__DistanceAssignment_2 ) ) ;
    public final void rule__Distance__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2853:1: ( ( ( rule__Distance__DistanceAssignment_2 ) ) )
            // InternalRobotDSL.g:2854:1: ( ( rule__Distance__DistanceAssignment_2 ) )
            {
            // InternalRobotDSL.g:2854:1: ( ( rule__Distance__DistanceAssignment_2 ) )
            // InternalRobotDSL.g:2855:2: ( rule__Distance__DistanceAssignment_2 )
            {
             before(grammarAccess.getDistanceAccess().getDistanceAssignment_2()); 
            // InternalRobotDSL.g:2856:2: ( rule__Distance__DistanceAssignment_2 )
            // InternalRobotDSL.g:2856:3: rule__Distance__DistanceAssignment_2
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalRobotDSL.g:2864:1: rule__Distance__Group__3 : rule__Distance__Group__3__Impl ;
    public final void rule__Distance__Group__3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2868:1: ( rule__Distance__Group__3__Impl )
            // InternalRobotDSL.g:2869:2: rule__Distance__Group__3__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalRobotDSL.g:2875:1: rule__Distance__Group__3__Impl : ( 'cm' ) ;
    public final void rule__Distance__Group__3__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2879:1: ( ( 'cm' ) )
            // InternalRobotDSL.g:2880:1: ( 'cm' )
            {
            // InternalRobotDSL.g:2880:1: ( 'cm' )
            // InternalRobotDSL.g:2881:2: 'cm'
            {
    ...
    // InternalRobotDSL.g:2891:1: rule__Time__Group__0 : rule__Time__Group__0__Impl rule__Time__Group__1 ;
    public final void rule__Time__Group__0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2895:1: ( rule__Time__Group__0__Impl rule__Time__Group__1 )
            // InternalRobotDSL.g:2896:2: rule__Time__Group__0__Impl rule__Time__Group__1
            {
            pushFollow(FOLLOW_19);
    ...
    // InternalRobotDSL.g:2903:1: rule__Time__Group__0__Impl : ( 'Time:' ) ;
    public final void rule__Time__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2907:1: ( ( 'Time:' ) )
            // InternalRobotDSL.g:2908:1: ( 'Time:' )
            {
            // InternalRobotDSL.g:2908:1: ( 'Time:' )
            // InternalRobotDSL.g:2909:2: 'Time:'
            {
    ...
    // InternalRobotDSL.g:2918:1: rule__Time__Group__1 : rule__Time__Group__1__Impl rule__Time__Group__2 ;
    public final void rule__Time__Group__1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2922:1: ( rule__Time__Group__1__Impl rule__Time__Group__2 )
            // InternalRobotDSL.g:2923:2: rule__Time__Group__1__Impl rule__Time__Group__2
            {
    ...
    // InternalRobotDSL.g:2930:1: rule__Time__Group__1__Impl : ( ( rule__Time__SecAssignment_1 ) ) ;
    public final void rule__Time__Group__1__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2934:1: ( ( ( rule__Time__SecAssignment_1 ) ) )
            // InternalRobotDSL.g:2935:1: ( ( rule__Time__SecAssignment_1 ) )
            {
            // InternalRobotDSL.g:2935:1: ( ( rule__Time__SecAssignment_1 ) )
            // InternalRobotDSL.g:2936:2: ( rule__Time__SecAssignment_1 )
            {
             before(grammarAccess.getTimeAccess().getSecAssignment_1()); 
            // InternalRobotDSL.g:2937:2: ( rule__Time__SecAssignment_1 )
            // InternalRobotDSL.g:2937:3: rule__Time__SecAssignment_1
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalRobotDSL.g:2945:1: rule__Time__Group__2 : rule__Time__Group__2__Impl ;
    public final void rule__Time__Group__2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2949:1: ( rule__Time__Group__2__Impl )
            // InternalRobotDSL.g:2950:2: rule__Time__Group__2__Impl
            {
            pushFollow(FOLLOW_2);
    ...
    // InternalRobotDSL.g:2956:1: rule__Time__Group__2__Impl : ( 'sec' ) ;
    public final void rule__Time__Group__2__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2960:1: ( ( 'sec' ) )
            // InternalRobotDSL.g:2961:1: ( 'sec' )
            {
            // InternalRobotDSL.g:2961:1: ( 'sec' )
            // InternalRobotDSL.g:2962:2: 'sec'
            {
    ...
    // InternalRobotDSL.g:2972:1: rule__Missions__NameAssignment_1 : ( RULE_ID ) ;
    public final void rule__Missions__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2976:1: ( ( RULE_ID ) )
            // InternalRobotDSL.g:2977:2: ( RULE_ID )
            {
            // InternalRobotDSL.g:2977:2: ( RULE_ID )
            // InternalRobotDSL.g:2978:3: RULE_ID
            {
    ...
    // InternalRobotDSL.g:2987:1: rule__Missions__MissionListAssignment_3 : ( ruleMission ) ;
    public final void rule__Missions__MissionListAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:2991:1: ( ( ruleMission ) )
            // InternalRobotDSL.g:2992:2: ( ruleMission )
            {
            // InternalRobotDSL.g:2992:2: ( ruleMission )
            // InternalRobotDSL.g:2993:3: ruleMission
            {
    ...
    // InternalRobotDSL.g:3002:1: rule__Mission__NameAssignment_1 : ( RULE_ID ) ;
    public final void rule__Mission__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3006:1: ( ( RULE_ID ) )
            // InternalRobotDSL.g:3007:2: ( RULE_ID )
            {
            // InternalRobotDSL.g:3007:2: ( RULE_ID )
            // InternalRobotDSL.g:3008:3: RULE_ID
            {
    ...
    // InternalRobotDSL.g:3017:1: rule__Mission__FlagsListAssignment_3 : ( ruleFlag ) ;
    public final void rule__Mission__FlagsListAssignment_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3021:1: ( ( ruleFlag ) )
            // InternalRobotDSL.g:3022:2: ( ruleFlag )
            {
            // InternalRobotDSL.g:3022:2: ( ruleFlag )
            // InternalRobotDSL.g:3023:3: ruleFlag
            {
    ...
    // InternalRobotDSL.g:3032:1: rule__Mission__TaskListAssignment_5 : ( ruleTask ) ;
    public final void rule__Mission__TaskListAssignment_5() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3036:1: ( ( ruleTask ) )
            // InternalRobotDSL.g:3037:2: ( ruleTask )
            {
            // InternalRobotDSL.g:3037:2: ( ruleTask )
            // InternalRobotDSL.g:3038:3: ruleTask
            {
    ...
    // InternalRobotDSL.g:3047:1: rule__Mission__GoalAssignment_7 : ( ruleGoal ) ;
    public final void rule__Mission__GoalAssignment_7() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3051:1: ( ( ruleGoal ) )
            // InternalRobotDSL.g:3052:2: ( ruleGoal )
            {
            // InternalRobotDSL.g:3052:2: ( ruleGoal )
            // InternalRobotDSL.g:3053:3: ruleGoal
            {
    ...
    // InternalRobotDSL.g:3062:1: rule__Goal__GoalEventsAssignment_0_1 : ( ruleTrigger ) ;
    public final void rule__Goal__GoalEventsAssignment_0_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3066:1: ( ( ruleTrigger ) )
            // InternalRobotDSL.g:3067:2: ( ruleTrigger )
            {
            // InternalRobotDSL.g:3067:2: ( ruleTrigger )
            // InternalRobotDSL.g:3068:3: ruleTrigger
            {
    ...
    // InternalRobotDSL.g:3077:1: rule__Goal__TimeoutAssignment_1 : ( ruleTime ) ;
    public final void rule__Goal__TimeoutAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3081:1: ( ( ruleTime ) )
            // InternalRobotDSL.g:3082:2: ( ruleTime )
            {
            // InternalRobotDSL.g:3082:2: ( ruleTime )
            // InternalRobotDSL.g:3083:3: ruleTime
            {
    ...
    // InternalRobotDSL.g:3092:1: rule__Goal__FinishActionsAssignment_2_1 : ( ruleAction ) ;
    ...
    // InternalRobotDSL.g:3107:1: rule__Task__NameAssignment_1 : ( RULE_ID ) ;
    public final void rule__Task__NameAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3111:1: ( ( RULE_ID ) )
            // InternalRobotDSL.g:3112:2: ( RULE_ID )
            {
            // InternalRobotDSL.g:3112:2: ( RULE_ID )
            // InternalRobotDSL.g:3113:3: RULE_ID
            {
    ...
    // InternalRobotDSL.g:3122:1: rule__Task__PrioAssignment_3 : ( RULE_INT ) ;
    ...
    // InternalRobotDSL.g:3137:1: rule__Task__TriggerListAssignment_4_1 : ( ruleTrigger ) ;
    public final void rule__Task__TriggerListAssignment_4_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3141:1: ( ( ruleTrigger ) )
            // InternalRobotDSL.g:3142:2: ( ruleTrigger )
            {
            // InternalRobotDSL.g:3142:2: ( ruleTrigger )
            // InternalRobotDSL.g:3143:3: ruleTrigger
            {
    ...
    // InternalRobotDSL.g:3152:1: rule__Task__ActionListAssignment_6 : ( ruleAction ) ;
    public final void rule__Task__ActionListAssignment_6() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3156:1: ( ( ruleAction ) )
            // InternalRobotDSL.g:3157:2: ( ruleAction )
            {
            // InternalRobotDSL.g:3157:2: ( ruleAction )
            // InternalRobotDSL.g:3158:3: ruleAction
            {
    ...
    // InternalRobotDSL.g:3167:1: rule__Action__MoveDirAssignment_0_1 : ( ruleDirection ) ;
    public final void rule__Action__MoveDirAssignment_0_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3171:1: ( ( ruleDirection ) )
            // InternalRobotDSL.g:3172:2: ( ruleDirection )
            {
            // InternalRobotDSL.g:3172:2: ( ruleDirection )
            // InternalRobotDSL.g:3173:3: ruleDirection
            {
    ...
    // InternalRobotDSL.g:3182:1: rule__Action__DurationAssignment_0_2_1 : ( RULE_INT ) ;
    public final void rule__Action__DurationAssignment_0_2_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3186:1: ( ( RULE_INT ) )
            // InternalRobotDSL.g:3187:2: ( RULE_INT )
            {
            // InternalRobotDSL.g:3187:2: ( RULE_INT )
            // InternalRobotDSL.g:3188:3: RULE_INT
            {
    ...
    // InternalRobotDSL.g:3197:1: rule__Action__SpeedAssignment_0_3_1 : ( ruleSpeed ) ;
    public final void rule__Action__SpeedAssignment_0_3_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3201:1: ( ( ruleSpeed ) )
            // InternalRobotDSL.g:3202:2: ( ruleSpeed )
            {
            // InternalRobotDSL.g:3202:2: ( ruleSpeed )
            // InternalRobotDSL.g:3203:3: ruleSpeed
            {
    ...
    // InternalRobotDSL.g:3212:1: rule__Action__TurnDirAssignment_1_1 : ( ruleDirection ) ;
    public final void rule__Action__TurnDirAssignment_1_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3216:1: ( ( ruleDirection ) )
            // InternalRobotDSL.g:3217:2: ( ruleDirection )
            {
            // InternalRobotDSL.g:3217:2: ( ruleDirection )
            // InternalRobotDSL.g:3218:3: ruleDirection
            {
    ...
    // InternalRobotDSL.g:3227:1: rule__Action__DegrAssignment_1_2_0_0 : ( RULE_INT ) ;
    public final void rule__Action__DegrAssignment_1_2_0_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3231:1: ( ( RULE_INT ) )
            // InternalRobotDSL.g:3232:2: ( RULE_INT )
            {
            // InternalRobotDSL.g:3232:2: ( RULE_INT )
            // InternalRobotDSL.g:3233:3: RULE_INT
            {
    ...
    // InternalRobotDSL.g:3242:1: rule__Action__TrigAssignment_1_2_1_1 : ( ruleTrigger ) ;
    public final void rule__Action__TrigAssignment_1_2_1_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3246:1: ( ( ruleTrigger ) )
            // InternalRobotDSL.g:3247:2: ( ruleTrigger )
            {
            // InternalRobotDSL.g:3247:2: ( ruleTrigger )
            // InternalRobotDSL.g:3248:3: ruleTrigger
            {
    ...
    // InternalRobotDSL.g:3257:1: rule__Action__OpAssignment_2_1 : ( ruleArmOp ) ;
    public final void rule__Action__OpAssignment_2_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3261:1: ( ( ruleArmOp ) )
            // InternalRobotDSL.g:3262:2: ( ruleArmOp )
            {
            // InternalRobotDSL.g:3262:2: ( ruleArmOp )
            // InternalRobotDSL.g:3263:3: ruleArmOp
            {
    ...
    // InternalRobotDSL.g:3272:1: rule__Action__SoundAssignment_3_2 : ( ruleSound ) ;
    public final void rule__Action__SoundAssignment_3_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3276:1: ( ( ruleSound ) )
            // InternalRobotDSL.g:3277:2: ( ruleSound )
            {
            // InternalRobotDSL.g:3277:2: ( ruleSound )
            // InternalRobotDSL.g:3278:3: ruleSound
            {
    ...
    // InternalRobotDSL.g:3287:1: rule__Action__FlagAssignment_4_1 : ( ( RULE_ID ) ) ;
    public final void rule__Action__FlagAssignment_4_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3291:1: ( ( ( RULE_ID ) ) )
            // InternalRobotDSL.g:3292:2: ( ( RULE_ID ) )
            {
            // InternalRobotDSL.g:3292:2: ( ( RULE_ID ) )
            // InternalRobotDSL.g:3293:3: ( RULE_ID )
            {
             before(grammarAccess.getActionAccess().getFlagFlagCrossReference_4_1_0()); 
            // InternalRobotDSL.g:3294:3: ( RULE_ID )
            // InternalRobotDSL.g:3295:4: RULE_ID
            {
    ...
    // InternalRobotDSL.g:3306:1: rule__Action__BoolAssignment_4_3 : ( ruleBool ) ;
    public final void rule__Action__BoolAssignment_4_3() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3310:1: ( ( ruleBool ) )
            // InternalRobotDSL.g:3311:2: ( ruleBool )
            {
            // InternalRobotDSL.g:3311:2: ( ruleBool )
            // InternalRobotDSL.g:3312:3: ruleBool
            {
    ...
    // InternalRobotDSL.g:3321:1: rule__Action__CentAssignment_5 : ( ( 'Centalize' ) ) ;
    public final void rule__Action__CentAssignment_5() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3325:1: ( ( ( 'Centalize' ) ) )
            // InternalRobotDSL.g:3326:2: ( ( 'Centalize' ) )
            {
            // InternalRobotDSL.g:3326:2: ( ( 'Centalize' ) )
            // InternalRobotDSL.g:3327:3: ( 'Centalize' )
            {
             before(grammarAccess.getActionAccess().getCentCentalizeKeyword_5_0()); 
            // InternalRobotDSL.g:3328:3: ( 'Centalize' )
            // InternalRobotDSL.g:3329:4: 'Centalize'
            {
             before(grammarAccess.getActionAccess().getCentCentalizeKeyword_5_0()); 
    ...
    // InternalRobotDSL.g:3340:1: rule__Trigger__BoolTypeAssignment_0 : ( ruleBool ) ;
    public final void rule__Trigger__BoolTypeAssignment_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3344:1: ( ( ruleBool ) )
            // InternalRobotDSL.g:3345:2: ( ruleBool )
            {
            // InternalRobotDSL.g:3345:2: ( ruleBool )
            // InternalRobotDSL.g:3346:3: ruleBool
            {
    ...
    // InternalRobotDSL.g:3355:1: rule__Trigger__NegAssignment_1_0_0 : ( ruleNegation ) ;
    public final void rule__Trigger__NegAssignment_1_0_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3359:1: ( ( ruleNegation ) )
            // InternalRobotDSL.g:3360:2: ( ruleNegation )
            {
            // InternalRobotDSL.g:3360:2: ( ruleNegation )
            // InternalRobotDSL.g:3361:3: ruleNegation
            {
    ...
    // InternalRobotDSL.g:3370:1: rule__Trigger__FlagAssignment_1_0_1 : ( ( RULE_ID ) ) ;
    public final void rule__Trigger__FlagAssignment_1_0_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3374:1: ( ( ( RULE_ID ) ) )
            // InternalRobotDSL.g:3375:2: ( ( RULE_ID ) )
            {
            // InternalRobotDSL.g:3375:2: ( ( RULE_ID ) )
            // InternalRobotDSL.g:3376:3: ( RULE_ID )
            {
             before(grammarAccess.getTriggerAccess().getFlagFlagCrossReference_1_0_1_0()); 
            // InternalRobotDSL.g:3377:3: ( RULE_ID )
            // InternalRobotDSL.g:3378:4: RULE_ID
            {
    ...
    // InternalRobotDSL.g:3389:1: rule__Trigger__SensorAssignment_1_1_0 : ( ruleSensor ) ;
    public final void rule__Trigger__SensorAssignment_1_1_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3393:1: ( ( ruleSensor ) )
            // InternalRobotDSL.g:3394:2: ( ruleSensor )
            {
            // InternalRobotDSL.g:3394:2: ( ruleSensor )
            // InternalRobotDSL.g:3395:3: ruleSensor
            {
    ...
    // InternalRobotDSL.g:3404:1: rule__Trigger__ColorAssignment_1_1_1_0_1 : ( ruleColor ) ;
    public final void rule__Trigger__ColorAssignment_1_1_1_0_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3408:1: ( ( ruleColor ) )
            // InternalRobotDSL.g:3409:2: ( ruleColor )
            {
            // InternalRobotDSL.g:3409:2: ( ruleColor )
            // InternalRobotDSL.g:3410:3: ruleColor
            {
    ...
    // InternalRobotDSL.g:3419:1: rule__Trigger__DistAssignment_1_1_1_1_1 : ( ruleDistance ) ;
    public final void rule__Trigger__DistAssignment_1_1_1_1_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3423:1: ( ( ruleDistance ) )
            // InternalRobotDSL.g:3424:2: ( ruleDistance )
            {
            // InternalRobotDSL.g:3424:2: ( ruleDistance )
            // InternalRobotDSL.g:3425:3: ruleDistance
            {
    ...
    // $ANTLR start "rule__Trigger__TouchingAssignment_1_1_1_2"
    // InternalRobotDSL.g:3434:1: rule__Trigger__TouchingAssignment_1_1_1_2 : ( ( 'touching' ) ) ;
    public final void rule__Trigger__TouchingAssignment_1_1_1_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3438:1: ( ( ( 'touching' ) ) )
            // InternalRobotDSL.g:3439:2: ( ( 'touching' ) )
            {
            // InternalRobotDSL.g:3439:2: ( ( 'touching' ) )
            // InternalRobotDSL.g:3440:3: ( 'touching' )
            {
             before(grammarAccess.getTriggerAccess().getTouchingTouchingKeyword_1_1_1_2_0()); 
            // InternalRobotDSL.g:3441:3: ( 'touching' )
            // InternalRobotDSL.g:3442:4: 'touching'
            {
             before(grammarAccess.getTriggerAccess().getTouchingTouchingKeyword_1_1_1_2_0()); 
            match(input,73,FOLLOW_2); 
             after(grammarAccess.getTriggerAccess().getTouchingTouchingKeyword_1_1_1_2_0()); 
    ...
    // $ANTLR end "rule__Trigger__TouchingAssignment_1_1_1_2"


    // $ANTLR start "rule__Trigger__DegreesAssignment_1_1_1_3_1"
    // InternalRobotDSL.g:3453:1: rule__Trigger__DegreesAssignment_1_1_1_3_1 : ( RULE_INT ) ;
    public final void rule__Trigger__DegreesAssignment_1_1_1_3_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3457:1: ( ( RULE_INT ) )
            // InternalRobotDSL.g:3458:2: ( RULE_INT )
            {
            // InternalRobotDSL.g:3458:2: ( RULE_INT )
            // InternalRobotDSL.g:3459:3: RULE_INT
            {
             before(grammarAccess.getTriggerAccess().getDegreesINTTerminalRuleCall_1_1_1_3_1_0()); 
            match(input,RULE_INT,FOLLOW_2); 
             after(grammarAccess.getTriggerAccess().getDegreesINTTerminalRuleCall_1_1_1_3_1_0()); 
    ...
    // $ANTLR end "rule__Trigger__DegreesAssignment_1_1_1_3_1"


    // $ANTLR start "rule__Distance__RangeBoolAssignment_0"
    // InternalRobotDSL.g:3468:1: rule__Distance__RangeBoolAssignment_0 : ( ruleBool ) ;
    public final void rule__Distance__RangeBoolAssignment_0() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3472:1: ( ( ruleBool ) )
            // InternalRobotDSL.g:3473:2: ( ruleBool )
            {
            // InternalRobotDSL.g:3473:2: ( ruleBool )
            // InternalRobotDSL.g:3474:3: ruleBool
            {
    ...
    // InternalRobotDSL.g:3483:1: rule__Distance__DistanceAssignment_2 : ( RULE_INT ) ;
    public final void rule__Distance__DistanceAssignment_2() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3487:1: ( ( RULE_INT ) )
            // InternalRobotDSL.g:3488:2: ( RULE_INT )
            {
            // InternalRobotDSL.g:3488:2: ( RULE_INT )
            // InternalRobotDSL.g:3489:3: RULE_INT
            {
    ...
    // InternalRobotDSL.g:3498:1: rule__Flag__NameAssignment : ( RULE_ID ) ;
    public final void rule__Flag__NameAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3502:1: ( ( RULE_ID ) )
            // InternalRobotDSL.g:3503:2: ( RULE_ID )
            {
            // InternalRobotDSL.g:3503:2: ( RULE_ID )
            // InternalRobotDSL.g:3504:3: RULE_ID
            {
    ...
    // InternalRobotDSL.g:3513:1: rule__Time__SecAssignment_1 : ( RULE_INT ) ;
    public final void rule__Time__SecAssignment_1() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3517:1: ( ( RULE_INT ) )
            // InternalRobotDSL.g:3518:2: ( RULE_INT )
            {
            // InternalRobotDSL.g:3518:2: ( RULE_INT )
            // InternalRobotDSL.g:3519:3: RULE_INT
            {
    ...
    // InternalRobotDSL.g:3528:1: rule__Direction__DirAssignment : ( ruleDirectionVal ) ;
    public final void rule__Direction__DirAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3532:1: ( ( ruleDirectionVal ) )
            // InternalRobotDSL.g:3533:2: ( ruleDirectionVal )
            {
            // InternalRobotDSL.g:3533:2: ( ruleDirectionVal )
            // InternalRobotDSL.g:3534:3: ruleDirectionVal
            {
    ...
    // InternalRobotDSL.g:3543:1: rule__Speed__SpeedAssignment : ( ruleSpeedVal ) ;
    public final void rule__Speed__SpeedAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3547:1: ( ( ruleSpeedVal ) )
            // InternalRobotDSL.g:3548:2: ( ruleSpeedVal )
            {
            // InternalRobotDSL.g:3548:2: ( ruleSpeedVal )
            // InternalRobotDSL.g:3549:3: ruleSpeedVal
            {
    ...
    // InternalRobotDSL.g:3558:1: rule__ArmOp__OpTypeAssignment : ( ruleArmOpType ) ;
    public final void rule__ArmOp__OpTypeAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3562:1: ( ( ruleArmOpType ) )
            // InternalRobotDSL.g:3563:2: ( ruleArmOpType )
            {
            // InternalRobotDSL.g:3563:2: ( ruleArmOpType )
            // InternalRobotDSL.g:3564:3: ruleArmOpType
            {
    ...
    // InternalRobotDSL.g:3573:1: rule__Sound__SoundNameAssignment : ( ruleSoundName ) ;
    public final void rule__Sound__SoundNameAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3577:1: ( ( ruleSoundName ) )
            // InternalRobotDSL.g:3578:2: ( ruleSoundName )
            {
            // InternalRobotDSL.g:3578:2: ( ruleSoundName )
            // InternalRobotDSL.g:3579:3: ruleSoundName
            {
    ...
    // InternalRobotDSL.g:3588:1: rule__Sensor__SensorTypeAssignment : ( ruleSensorType ) ;
    public final void rule__Sensor__SensorTypeAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3592:1: ( ( ruleSensorType ) )
            // InternalRobotDSL.g:3593:2: ( ruleSensorType )
            {
            // InternalRobotDSL.g:3593:2: ( ruleSensorType )
            // InternalRobotDSL.g:3594:3: ruleSensorType
            {
    ...
    // InternalRobotDSL.g:3603:1: rule__Color__ColorNameAssignment : ( ruleColorName ) ;
    public final void rule__Color__ColorNameAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3607:1: ( ( ruleColorName ) )
            // InternalRobotDSL.g:3608:2: ( ruleColorName )
            {
            // InternalRobotDSL.g:3608:2: ( ruleColorName )
            // InternalRobotDSL.g:3609:3: ruleColorName
            {
    ...
    // InternalRobotDSL.g:3618:1: rule__Bool__BoolTypeAssignment : ( ruleBoolType ) ;
    public final void rule__Bool__BoolTypeAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3622:1: ( ( ruleBoolType ) )
            // InternalRobotDSL.g:3623:2: ( ruleBoolType )
            {
            // InternalRobotDSL.g:3623:2: ( ruleBoolType )
            // InternalRobotDSL.g:3624:3: ruleBoolType
            {
    ...
    // InternalRobotDSL.g:3633:1: rule__Negation__NOTAssignment : ( ( 'not' ) ) ;
    public final void rule__Negation__NOTAssignment() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalRobotDSL.g:3637:1: ( ( ( 'not' ) ) )
            // InternalRobotDSL.g:3638:2: ( ( 'not' ) )
            {
            // InternalRobotDSL.g:3638:2: ( ( 'not' ) )
            // InternalRobotDSL.g:3639:3: ( 'not' )
            {
             before(grammarAccess.getNegationAccess().getNOTNotKeyword_0()); 
            // InternalRobotDSL.g:3640:3: ( 'not' )
            // InternalRobotDSL.g:3641:4: 'not'
            {
             before(grammarAccess.getNegationAccess().getNOTNotKeyword_0()); 
    ...
    public static final BitSet FOLLOW_14 = new BitSet(new long[]{0x000001F83FC00010L,0x0000000000000400L});
    public static final BitSet FOLLOW_15 = new BitSet(new long[]{0x000001F83FC00012L,0x0000000000000400L});
    ...
    public static final BitSet FOLLOW_34 = new BitSet(new long[]{0x0000000000000000L,0x000000000000020EL});
