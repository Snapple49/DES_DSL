...
public class RobotDSLGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TriggerElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cTouchingAssignment_1_1_1_2 = (Assignment)cAlternatives_1_1_1.eContents().get(2);
		private final Keyword cTouchingTouchingKeyword_1_1_1_2_0 = (Keyword)cTouchingAssignment_1_1_1_2.eContents().get(0);
		private final Group cGroup_1_1_1_3 = (Group)cAlternatives_1_1_1.eContents().get(3);
		private final Keyword cSpunKeyword_1_1_1_3_0 = (Keyword)cGroup_1_1_1_3.eContents().get(0);
		private final Assignment cDegreesAssignment_1_1_1_3_1 = (Assignment)cGroup_1_1_1_3.eContents().get(1);
		private final RuleCall cDegreesINTTerminalRuleCall_1_1_1_3_1_0 = (RuleCall)cDegreesAssignment_1_1_1_3_1.eContents().get(0);
		
		//Trigger:
		//	boolType=Bool? (neg=Negation? flag=[Flag] | sensor=Sensor ('is' color=Color | 'distance' dist=Distance |
		//	touching='touching' | 'spun' degrees=INT));
		@Override public ParserRule getRule() { return rule; }
		...
		//(neg=Negation? flag=[Flag] | sensor=Sensor ('is' color=Color | 'distance' dist=Distance | touching='touching' | 'spun'
		//degrees=INT))
		...
		//sensor=Sensor ('is' color=Color | 'distance' dist=Distance | touching='touching' | 'spun' degrees=INT)
		...
		//touching='touching'
		public Assignment getTouchingAssignment_1_1_1_2() { return cTouchingAssignment_1_1_1_2; }
		
		//'touching'
		public Keyword getTouchingTouchingKeyword_1_1_1_2_0() { return cTouchingTouchingKeyword_1_1_1_2_0; }
		
		//'spun' degrees=INT
		public Group getGroup_1_1_1_3() { return cGroup_1_1_1_3; }
		
		//'spun'
		public Keyword getSpunKeyword_1_1_1_3_0() { return cSpunKeyword_1_1_1_3_0; }
		
		//degrees=INT
		public Assignment getDegreesAssignment_1_1_1_3_1() { return cDegreesAssignment_1_1_1_3_1; }
		
		//INT
		public RuleCall getDegreesINTTerminalRuleCall_1_1_1_3_1_0() { return cDegreesINTTerminalRuleCall_1_1_1_3_1_0; }
	}
