...
public class InternalRobotDSLParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'Missionset'", "'Missions:'", "'Mission'", "'Flags:'", "'Tasks:'", "'Goal:'", "'Condition:'", "'Actions:'", "'Task:'", "'priority:'", "'Triggers:'", "'Move'", "'for'", "'millisec'", "'at'", "'speed'", "'Turn'", "'deg'", "'until'", "'Arm'", "'Play'", "'sound'", "'Update'", "'to'", "'Centalize'", "'is'", "'distance'", "'touching'", "'spun'", "'than'", "'cm'", "'Time:'", "'sec'", "'not'", "'forward'", "'backward'", "'left'", "'right'", "'high'", "'medium'", "'low'", "'raise'", "'lower'", "'buzz'", "'fanfare'", "'Color'", "'LeftLight'", "'RightLight'", "'RearHeight'", "'FrontDistance'", "'LeftTouch'", "'RightTouch'", "'Gyro'", "'red'", "'white'", "'black'", "'green'", "'blue'", "'less'", "'greater'", "'and'", "'or'", "'true'", "'false'"
    };
            ...
            switch (alt5) {
                case 1 :
                    ...
                    do {
                        ...
                        if ( (LA4_0==RULE_ID||LA4_0==44||(LA4_0>=56 && LA4_0<=63)||(LA4_0>=69 && LA4_0<=74)) ) {
                            alt4=1;
                        }
            ...
            switch (alt10) {
                case 1 :
                    ...
                    do {
                        ...
                        if ( (LA9_0==RULE_ID||LA9_0==44||(LA9_0>=56 && LA9_0<=63)||(LA9_0>=69 && LA9_0<=74)) ) {
                            alt9=1;
                        }
                    ...
                    switch (alt15) {
                        ...
                        case 2 :
                            ...
                            do {
                                ...
                                if ( (LA14_0==RULE_ID||LA14_0==44||(LA14_0>=56 && LA14_0<=63)||(LA14_0>=69 && LA14_0<=74)) ) {
                                    alt14=1;
                                }
    ...
    // InternalRobotDSL.g:738:1: ruleTrigger returns [EObject current=null] : ( ( (lv_boolType_0_0= ruleBool ) )? ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) | ( (lv_touching_8_0= 'touching' ) ) | (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) ) ) ) ) ) ;
    public final EObject ruleTrigger() throws RecognitionException {
        ...
        Token otherlv_4=null;
        Token otherlv_6=null;
        Token lv_touching_8_0=null;
        Token otherlv_9=null;
        Token lv_degrees_10_0=null;
        ...
        try {
            // InternalRobotDSL.g:744:2: ( ( ( (lv_boolType_0_0= ruleBool ) )? ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) | ( (lv_touching_8_0= 'touching' ) ) | (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) ) ) ) ) ) )
            // InternalRobotDSL.g:745:2: ( ( (lv_boolType_0_0= ruleBool ) )? ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) | ( (lv_touching_8_0= 'touching' ) ) | (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) ) ) ) ) )
            {
            // InternalRobotDSL.g:745:2: ( ( (lv_boolType_0_0= ruleBool ) )? ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) | ( (lv_touching_8_0= 'touching' ) ) | (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) ) ) ) ) )
            // InternalRobotDSL.g:746:3: ( (lv_boolType_0_0= ruleBool ) )? ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) | ( (lv_touching_8_0= 'touching' ) ) | (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) ) ) ) )
            {
            // InternalRobotDSL.g:746:3: ( (lv_boolType_0_0= ruleBool ) )?
            int alt17=2;
            int LA17_0 = input.LA(1);

            if ( ((LA17_0>=69 && LA17_0<=74)) ) {
                alt17=1;
            }
            switch (alt17) {
                case 1 :
            ...
            // InternalRobotDSL.g:765:3: ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) | ( (lv_touching_8_0= 'touching' ) ) | (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) ) ) ) )
            int alt20=2;
            int LA20_0 = input.LA(1);

            if ( (LA20_0==RULE_ID||LA20_0==44) ) {
                alt20=1;
            }
            else if ( ((LA20_0>=56 && LA20_0<=63)) ) {
                alt20=2;
            }
            else {
                NoViableAltException nvae =
            ...
            switch (alt20) {
                case 1 :
                    // InternalRobotDSL.g:766:4: ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) )
                    {
                    // InternalRobotDSL.g:766:4: ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) )
                    // InternalRobotDSL.g:767:5: ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) )
                    {
                    ...
                    switch (alt18) {
                        case 1 :
                            // InternalRobotDSL.g:768:6: (lv_neg_1_0= ruleNegation )
                            {
                            // InternalRobotDSL.g:768:6: (lv_neg_1_0= ruleNegation )
                            // InternalRobotDSL.g:769:7: lv_neg_1_0= ruleNegation
                            {
                    ...
                    {
                    // InternalRobotDSL.g:787:6: (otherlv_2= RULE_ID )
                    // InternalRobotDSL.g:788:7: otherlv_2= RULE_ID
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:801:4: ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) | ( (lv_touching_8_0= 'touching' ) ) | (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) ) ) )
                    {
                    // InternalRobotDSL.g:801:4: ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) | ( (lv_touching_8_0= 'touching' ) ) | (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) ) ) )
                    // InternalRobotDSL.g:802:5: ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) | ( (lv_touching_8_0= 'touching' ) ) | (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) ) )
                    {
                    // InternalRobotDSL.g:802:5: ( (lv_sensor_3_0= ruleSensor ) )
                    // InternalRobotDSL.g:803:6: (lv_sensor_3_0= ruleSensor )
                    {
                    // InternalRobotDSL.g:803:6: (lv_sensor_3_0= ruleSensor )
                    // InternalRobotDSL.g:804:7: lv_sensor_3_0= ruleSensor
                    {
                    ...
                    // InternalRobotDSL.g:821:5: ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) | ( (lv_touching_8_0= 'touching' ) ) | (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) ) )
                    int alt19=4;
                    switch ( input.LA(1) ) {
                    case 36:
                        {
                    ...
                    switch (alt19) {
                        case 1 :
                            // InternalRobotDSL.g:822:6: (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) )
                            {
                            // InternalRobotDSL.g:822:6: (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) )
                            // InternalRobotDSL.g:823:7: otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) )
                            {
                            otherlv_4=(Token)match(input,36,FOLLOW_36); 

                            							newLeafNode(otherlv_4, grammarAccess.getTriggerAccess().getIsKeyword_1_1_1_0_0());
                            						
                            // InternalRobotDSL.g:827:7: ( (lv_color_5_0= ruleColor ) )
                            // InternalRobotDSL.g:828:8: (lv_color_5_0= ruleColor )
                            {
                            // InternalRobotDSL.g:828:8: (lv_color_5_0= ruleColor )
                            // InternalRobotDSL.g:829:9: lv_color_5_0= ruleColor
                            {
                            ...
                            break;
                        case 2 :
                            // InternalRobotDSL.g:848:6: (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) )
                            {
                            // InternalRobotDSL.g:848:6: (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) )
                            // InternalRobotDSL.g:849:7: otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) )
                            {
                            ...
                            // InternalRobotDSL.g:853:7: ( (lv_dist_7_0= ruleDistance ) )
                            // InternalRobotDSL.g:854:8: (lv_dist_7_0= ruleDistance )
                            {
                            // InternalRobotDSL.g:854:8: (lv_dist_7_0= ruleDistance )
                            // InternalRobotDSL.g:855:9: lv_dist_7_0= ruleDistance
                            {
                            ...
                            break;
                        case 3 :
                            // InternalRobotDSL.g:874:6: ( (lv_touching_8_0= 'touching' ) )
                            {
                            // InternalRobotDSL.g:874:6: ( (lv_touching_8_0= 'touching' ) )
                            // InternalRobotDSL.g:875:7: (lv_touching_8_0= 'touching' )
                            {
                            // InternalRobotDSL.g:875:7: (lv_touching_8_0= 'touching' )
                            // InternalRobotDSL.g:876:8: lv_touching_8_0= 'touching'
                            {
                            lv_touching_8_0=(Token)match(input,38,FOLLOW_2); 

                            								newLeafNode(lv_touching_8_0, grammarAccess.getTriggerAccess().getTouchingTouchingKeyword_1_1_1_2_0());
                            							

                            								if (current==null) {
                            									current = createModelElement(grammarAccess.getTriggerRule());
                            								}
                            								setWithLastConsumed(current, "touching", lv_touching_8_0, "touching");
                            ...
                            break;
                        case 4 :
                            // InternalRobotDSL.g:889:6: (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) )
                            {
                            // InternalRobotDSL.g:889:6: (otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) ) )
                            // InternalRobotDSL.g:890:7: otherlv_9= 'spun' ( (lv_degrees_10_0= RULE_INT ) )
                            {
                            otherlv_9=(Token)match(input,39,FOLLOW_18); 

                            							newLeafNode(otherlv_9, grammarAccess.getTriggerAccess().getSpunKeyword_1_1_1_3_0());
                            						
                            // InternalRobotDSL.g:894:7: ( (lv_degrees_10_0= RULE_INT ) )
                            // InternalRobotDSL.g:895:8: (lv_degrees_10_0= RULE_INT )
                            {
                            // InternalRobotDSL.g:895:8: (lv_degrees_10_0= RULE_INT )
                            // InternalRobotDSL.g:896:9: lv_degrees_10_0= RULE_INT
                            {
                            lv_degrees_10_0=(Token)match(input,RULE_INT,FOLLOW_2); 

                            									newLeafNode(lv_degrees_10_0, grammarAccess.getTriggerAccess().getDegreesINTTerminalRuleCall_1_1_1_3_1_0());
    ...
    // InternalRobotDSL.g:920:1: entryRuleDistance returns [EObject current=null] : iv_ruleDistance= ruleDistance EOF ;
    public final EObject entryRuleDistance() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:920:49: (iv_ruleDistance= ruleDistance EOF )
            // InternalRobotDSL.g:921:2: iv_ruleDistance= ruleDistance EOF
            {
    ...
    // InternalRobotDSL.g:927:1: ruleDistance returns [EObject current=null] : ( ( (lv_rangeBool_0_0= ruleBool ) ) otherlv_1= 'than' ( (lv_distance_2_0= RULE_INT ) ) otherlv_3= 'cm' ) ;
    public final EObject ruleDistance() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:933:2: ( ( ( (lv_rangeBool_0_0= ruleBool ) ) otherlv_1= 'than' ( (lv_distance_2_0= RULE_INT ) ) otherlv_3= 'cm' ) )
            // InternalRobotDSL.g:934:2: ( ( (lv_rangeBool_0_0= ruleBool ) ) otherlv_1= 'than' ( (lv_distance_2_0= RULE_INT ) ) otherlv_3= 'cm' )
            {
            // InternalRobotDSL.g:934:2: ( ( (lv_rangeBool_0_0= ruleBool ) ) otherlv_1= 'than' ( (lv_distance_2_0= RULE_INT ) ) otherlv_3= 'cm' )
            // InternalRobotDSL.g:935:3: ( (lv_rangeBool_0_0= ruleBool ) ) otherlv_1= 'than' ( (lv_distance_2_0= RULE_INT ) ) otherlv_3= 'cm'
            {
            // InternalRobotDSL.g:935:3: ( (lv_rangeBool_0_0= ruleBool ) )
            // InternalRobotDSL.g:936:4: (lv_rangeBool_0_0= ruleBool )
            {
            // InternalRobotDSL.g:936:4: (lv_rangeBool_0_0= ruleBool )
            // InternalRobotDSL.g:937:5: lv_rangeBool_0_0= ruleBool
            {
            ...
            // InternalRobotDSL.g:958:3: ( (lv_distance_2_0= RULE_INT ) )
            // InternalRobotDSL.g:959:4: (lv_distance_2_0= RULE_INT )
            {
            // InternalRobotDSL.g:959:4: (lv_distance_2_0= RULE_INT )
            // InternalRobotDSL.g:960:5: lv_distance_2_0= RULE_INT
            {
    ...
    // InternalRobotDSL.g:984:1: entryRuleFlag returns [EObject current=null] : iv_ruleFlag= ruleFlag EOF ;
    public final EObject entryRuleFlag() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:984:45: (iv_ruleFlag= ruleFlag EOF )
            // InternalRobotDSL.g:985:2: iv_ruleFlag= ruleFlag EOF
            {
    ...
    // InternalRobotDSL.g:991:1: ruleFlag returns [EObject current=null] : ( (lv_name_0_0= RULE_ID ) ) ;
    public final EObject ruleFlag() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:997:2: ( ( (lv_name_0_0= RULE_ID ) ) )
            // InternalRobotDSL.g:998:2: ( (lv_name_0_0= RULE_ID ) )
            {
            // InternalRobotDSL.g:998:2: ( (lv_name_0_0= RULE_ID ) )
            // InternalRobotDSL.g:999:3: (lv_name_0_0= RULE_ID )
            {
            // InternalRobotDSL.g:999:3: (lv_name_0_0= RULE_ID )
            // InternalRobotDSL.g:1000:4: lv_name_0_0= RULE_ID
            {
    ...
    // InternalRobotDSL.g:1019:1: entryRuleTime returns [EObject current=null] : iv_ruleTime= ruleTime EOF ;
    public final EObject entryRuleTime() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1019:45: (iv_ruleTime= ruleTime EOF )
            // InternalRobotDSL.g:1020:2: iv_ruleTime= ruleTime EOF
            {
    ...
    // InternalRobotDSL.g:1026:1: ruleTime returns [EObject current=null] : (otherlv_0= 'Time:' ( (lv_sec_1_0= RULE_INT ) ) otherlv_2= 'sec' ) ;
    public final EObject ruleTime() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1032:2: ( (otherlv_0= 'Time:' ( (lv_sec_1_0= RULE_INT ) ) otherlv_2= 'sec' ) )
            // InternalRobotDSL.g:1033:2: (otherlv_0= 'Time:' ( (lv_sec_1_0= RULE_INT ) ) otherlv_2= 'sec' )
            {
            // InternalRobotDSL.g:1033:2: (otherlv_0= 'Time:' ( (lv_sec_1_0= RULE_INT ) ) otherlv_2= 'sec' )
            // InternalRobotDSL.g:1034:3: otherlv_0= 'Time:' ( (lv_sec_1_0= RULE_INT ) ) otherlv_2= 'sec'
            {
            otherlv_0=(Token)match(input,42,FOLLOW_18); 

            			newLeafNode(otherlv_0, grammarAccess.getTimeAccess().getTimeKeyword_0());
            		
            // InternalRobotDSL.g:1038:3: ( (lv_sec_1_0= RULE_INT ) )
            // InternalRobotDSL.g:1039:4: (lv_sec_1_0= RULE_INT )
            {
            // InternalRobotDSL.g:1039:4: (lv_sec_1_0= RULE_INT )
            // InternalRobotDSL.g:1040:5: lv_sec_1_0= RULE_INT
            {
    ...
    // InternalRobotDSL.g:1064:1: entryRuleDirection returns [EObject current=null] : iv_ruleDirection= ruleDirection EOF ;
    public final EObject entryRuleDirection() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1064:50: (iv_ruleDirection= ruleDirection EOF )
            // InternalRobotDSL.g:1065:2: iv_ruleDirection= ruleDirection EOF
            {
    ...
    // InternalRobotDSL.g:1071:1: ruleDirection returns [EObject current=null] : ( (lv_dir_0_0= ruleDirectionVal ) ) ;
    public final EObject ruleDirection() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1077:2: ( ( (lv_dir_0_0= ruleDirectionVal ) ) )
            // InternalRobotDSL.g:1078:2: ( (lv_dir_0_0= ruleDirectionVal ) )
            {
            // InternalRobotDSL.g:1078:2: ( (lv_dir_0_0= ruleDirectionVal ) )
            // InternalRobotDSL.g:1079:3: (lv_dir_0_0= ruleDirectionVal )
            {
            // InternalRobotDSL.g:1079:3: (lv_dir_0_0= ruleDirectionVal )
            // InternalRobotDSL.g:1080:4: lv_dir_0_0= ruleDirectionVal
            {
    ...
    // InternalRobotDSL.g:1100:1: entryRuleSpeed returns [EObject current=null] : iv_ruleSpeed= ruleSpeed EOF ;
    public final EObject entryRuleSpeed() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1100:46: (iv_ruleSpeed= ruleSpeed EOF )
            // InternalRobotDSL.g:1101:2: iv_ruleSpeed= ruleSpeed EOF
            {
    ...
    // InternalRobotDSL.g:1107:1: ruleSpeed returns [EObject current=null] : ( (lv_speed_0_0= ruleSpeedVal ) ) ;
    public final EObject ruleSpeed() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1113:2: ( ( (lv_speed_0_0= ruleSpeedVal ) ) )
            // InternalRobotDSL.g:1114:2: ( (lv_speed_0_0= ruleSpeedVal ) )
            {
            // InternalRobotDSL.g:1114:2: ( (lv_speed_0_0= ruleSpeedVal ) )
            // InternalRobotDSL.g:1115:3: (lv_speed_0_0= ruleSpeedVal )
            {
            // InternalRobotDSL.g:1115:3: (lv_speed_0_0= ruleSpeedVal )
            // InternalRobotDSL.g:1116:4: lv_speed_0_0= ruleSpeedVal
            {
    ...
    // InternalRobotDSL.g:1136:1: entryRuleArmOp returns [EObject current=null] : iv_ruleArmOp= ruleArmOp EOF ;
    public final EObject entryRuleArmOp() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1136:46: (iv_ruleArmOp= ruleArmOp EOF )
            // InternalRobotDSL.g:1137:2: iv_ruleArmOp= ruleArmOp EOF
            {
    ...
    // InternalRobotDSL.g:1143:1: ruleArmOp returns [EObject current=null] : ( (lv_opType_0_0= ruleArmOpType ) ) ;
    public final EObject ruleArmOp() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1149:2: ( ( (lv_opType_0_0= ruleArmOpType ) ) )
            // InternalRobotDSL.g:1150:2: ( (lv_opType_0_0= ruleArmOpType ) )
            {
            // InternalRobotDSL.g:1150:2: ( (lv_opType_0_0= ruleArmOpType ) )
            // InternalRobotDSL.g:1151:3: (lv_opType_0_0= ruleArmOpType )
            {
            // InternalRobotDSL.g:1151:3: (lv_opType_0_0= ruleArmOpType )
            // InternalRobotDSL.g:1152:4: lv_opType_0_0= ruleArmOpType
            {
    ...
    // InternalRobotDSL.g:1172:1: entryRuleSound returns [EObject current=null] : iv_ruleSound= ruleSound EOF ;
    public final EObject entryRuleSound() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1172:46: (iv_ruleSound= ruleSound EOF )
            // InternalRobotDSL.g:1173:2: iv_ruleSound= ruleSound EOF
            {
    ...
    // InternalRobotDSL.g:1179:1: ruleSound returns [EObject current=null] : ( (lv_soundName_0_0= ruleSoundName ) ) ;
    public final EObject ruleSound() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1185:2: ( ( (lv_soundName_0_0= ruleSoundName ) ) )
            // InternalRobotDSL.g:1186:2: ( (lv_soundName_0_0= ruleSoundName ) )
            {
            // InternalRobotDSL.g:1186:2: ( (lv_soundName_0_0= ruleSoundName ) )
            // InternalRobotDSL.g:1187:3: (lv_soundName_0_0= ruleSoundName )
            {
            // InternalRobotDSL.g:1187:3: (lv_soundName_0_0= ruleSoundName )
            // InternalRobotDSL.g:1188:4: lv_soundName_0_0= ruleSoundName
            {
    ...
    // InternalRobotDSL.g:1208:1: entryRuleSensor returns [EObject current=null] : iv_ruleSensor= ruleSensor EOF ;
    public final EObject entryRuleSensor() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1208:47: (iv_ruleSensor= ruleSensor EOF )
            // InternalRobotDSL.g:1209:2: iv_ruleSensor= ruleSensor EOF
            {
    ...
    // InternalRobotDSL.g:1215:1: ruleSensor returns [EObject current=null] : ( (lv_sensorType_0_0= ruleSensorType ) ) ;
    public final EObject ruleSensor() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1221:2: ( ( (lv_sensorType_0_0= ruleSensorType ) ) )
            // InternalRobotDSL.g:1222:2: ( (lv_sensorType_0_0= ruleSensorType ) )
            {
            // InternalRobotDSL.g:1222:2: ( (lv_sensorType_0_0= ruleSensorType ) )
            // InternalRobotDSL.g:1223:3: (lv_sensorType_0_0= ruleSensorType )
            {
            // InternalRobotDSL.g:1223:3: (lv_sensorType_0_0= ruleSensorType )
            // InternalRobotDSL.g:1224:4: lv_sensorType_0_0= ruleSensorType
            {
    ...
    // InternalRobotDSL.g:1244:1: entryRuleColor returns [EObject current=null] : iv_ruleColor= ruleColor EOF ;
    public final EObject entryRuleColor() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1244:46: (iv_ruleColor= ruleColor EOF )
            // InternalRobotDSL.g:1245:2: iv_ruleColor= ruleColor EOF
            {
    ...
    // InternalRobotDSL.g:1251:1: ruleColor returns [EObject current=null] : ( (lv_colorName_0_0= ruleColorName ) ) ;
    public final EObject ruleColor() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1257:2: ( ( (lv_colorName_0_0= ruleColorName ) ) )
            // InternalRobotDSL.g:1258:2: ( (lv_colorName_0_0= ruleColorName ) )
            {
            // InternalRobotDSL.g:1258:2: ( (lv_colorName_0_0= ruleColorName ) )
            // InternalRobotDSL.g:1259:3: (lv_colorName_0_0= ruleColorName )
            {
            // InternalRobotDSL.g:1259:3: (lv_colorName_0_0= ruleColorName )
            // InternalRobotDSL.g:1260:4: lv_colorName_0_0= ruleColorName
            {
    ...
    // InternalRobotDSL.g:1280:1: entryRuleBool returns [EObject current=null] : iv_ruleBool= ruleBool EOF ;
    public final EObject entryRuleBool() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1280:45: (iv_ruleBool= ruleBool EOF )
            // InternalRobotDSL.g:1281:2: iv_ruleBool= ruleBool EOF
            {
    ...
    // InternalRobotDSL.g:1287:1: ruleBool returns [EObject current=null] : ( (lv_boolType_0_0= ruleBoolType ) ) ;
    public final EObject ruleBool() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1293:2: ( ( (lv_boolType_0_0= ruleBoolType ) ) )
            // InternalRobotDSL.g:1294:2: ( (lv_boolType_0_0= ruleBoolType ) )
            {
            // InternalRobotDSL.g:1294:2: ( (lv_boolType_0_0= ruleBoolType ) )
            // InternalRobotDSL.g:1295:3: (lv_boolType_0_0= ruleBoolType )
            {
            // InternalRobotDSL.g:1295:3: (lv_boolType_0_0= ruleBoolType )
            // InternalRobotDSL.g:1296:4: lv_boolType_0_0= ruleBoolType
            {
    ...
    // InternalRobotDSL.g:1316:1: entryRuleNegation returns [EObject current=null] : iv_ruleNegation= ruleNegation EOF ;
    public final EObject entryRuleNegation() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1316:49: (iv_ruleNegation= ruleNegation EOF )
            // InternalRobotDSL.g:1317:2: iv_ruleNegation= ruleNegation EOF
            {
    ...
    // InternalRobotDSL.g:1323:1: ruleNegation returns [EObject current=null] : ( (lv_NOT_0_0= 'not' ) ) ;
    public final EObject ruleNegation() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1329:2: ( ( (lv_NOT_0_0= 'not' ) ) )
            // InternalRobotDSL.g:1330:2: ( (lv_NOT_0_0= 'not' ) )
            {
            // InternalRobotDSL.g:1330:2: ( (lv_NOT_0_0= 'not' ) )
            // InternalRobotDSL.g:1331:3: (lv_NOT_0_0= 'not' )
            {
            // InternalRobotDSL.g:1331:3: (lv_NOT_0_0= 'not' )
            // InternalRobotDSL.g:1332:4: lv_NOT_0_0= 'not'
            {
            lv_NOT_0_0=(Token)match(input,44,FOLLOW_2); 
    ...
    // InternalRobotDSL.g:1347:1: ruleDirectionVal returns [Enumerator current=null] : ( (enumLiteral_0= 'forward' ) | (enumLiteral_1= 'backward' ) | (enumLiteral_2= 'left' ) | (enumLiteral_3= 'right' ) ) ;
    public final Enumerator ruleDirectionVal() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1353:2: ( ( (enumLiteral_0= 'forward' ) | (enumLiteral_1= 'backward' ) | (enumLiteral_2= 'left' ) | (enumLiteral_3= 'right' ) ) )
            // InternalRobotDSL.g:1354:2: ( (enumLiteral_0= 'forward' ) | (enumLiteral_1= 'backward' ) | (enumLiteral_2= 'left' ) | (enumLiteral_3= 'right' ) )
            {
            // InternalRobotDSL.g:1354:2: ( (enumLiteral_0= 'forward' ) | (enumLiteral_1= 'backward' ) | (enumLiteral_2= 'left' ) | (enumLiteral_3= 'right' ) )
            int alt21=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt21) {
                case 1 :
                    // InternalRobotDSL.g:1355:3: (enumLiteral_0= 'forward' )
                    {
                    // InternalRobotDSL.g:1355:3: (enumLiteral_0= 'forward' )
                    // InternalRobotDSL.g:1356:4: enumLiteral_0= 'forward'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1363:3: (enumLiteral_1= 'backward' )
                    {
                    // InternalRobotDSL.g:1363:3: (enumLiteral_1= 'backward' )
                    // InternalRobotDSL.g:1364:4: enumLiteral_1= 'backward'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:1371:3: (enumLiteral_2= 'left' )
                    {
                    // InternalRobotDSL.g:1371:3: (enumLiteral_2= 'left' )
                    // InternalRobotDSL.g:1372:4: enumLiteral_2= 'left'
                    {
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:1379:3: (enumLiteral_3= 'right' )
                    {
                    // InternalRobotDSL.g:1379:3: (enumLiteral_3= 'right' )
                    // InternalRobotDSL.g:1380:4: enumLiteral_3= 'right'
                    {
    ...
    // InternalRobotDSL.g:1390:1: ruleSpeedVal returns [Enumerator current=null] : ( (enumLiteral_0= 'high' ) | (enumLiteral_1= 'medium' ) | (enumLiteral_2= 'low' ) ) ;
    public final Enumerator ruleSpeedVal() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1396:2: ( ( (enumLiteral_0= 'high' ) | (enumLiteral_1= 'medium' ) | (enumLiteral_2= 'low' ) ) )
            // InternalRobotDSL.g:1397:2: ( (enumLiteral_0= 'high' ) | (enumLiteral_1= 'medium' ) | (enumLiteral_2= 'low' ) )
            {
            // InternalRobotDSL.g:1397:2: ( (enumLiteral_0= 'high' ) | (enumLiteral_1= 'medium' ) | (enumLiteral_2= 'low' ) )
            int alt22=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt22) {
                case 1 :
                    // InternalRobotDSL.g:1398:3: (enumLiteral_0= 'high' )
                    {
                    // InternalRobotDSL.g:1398:3: (enumLiteral_0= 'high' )
                    // InternalRobotDSL.g:1399:4: enumLiteral_0= 'high'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1406:3: (enumLiteral_1= 'medium' )
                    {
                    // InternalRobotDSL.g:1406:3: (enumLiteral_1= 'medium' )
                    // InternalRobotDSL.g:1407:4: enumLiteral_1= 'medium'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:1414:3: (enumLiteral_2= 'low' )
                    {
                    // InternalRobotDSL.g:1414:3: (enumLiteral_2= 'low' )
                    // InternalRobotDSL.g:1415:4: enumLiteral_2= 'low'
                    {
    ...
    // InternalRobotDSL.g:1425:1: ruleArmOpType returns [Enumerator current=null] : ( (enumLiteral_0= 'raise' ) | (enumLiteral_1= 'lower' ) ) ;
    public final Enumerator ruleArmOpType() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1431:2: ( ( (enumLiteral_0= 'raise' ) | (enumLiteral_1= 'lower' ) ) )
            // InternalRobotDSL.g:1432:2: ( (enumLiteral_0= 'raise' ) | (enumLiteral_1= 'lower' ) )
            {
            // InternalRobotDSL.g:1432:2: ( (enumLiteral_0= 'raise' ) | (enumLiteral_1= 'lower' ) )
            int alt23=2;
            ...
            switch (alt23) {
                case 1 :
                    // InternalRobotDSL.g:1433:3: (enumLiteral_0= 'raise' )
                    {
                    // InternalRobotDSL.g:1433:3: (enumLiteral_0= 'raise' )
                    // InternalRobotDSL.g:1434:4: enumLiteral_0= 'raise'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1441:3: (enumLiteral_1= 'lower' )
                    {
                    // InternalRobotDSL.g:1441:3: (enumLiteral_1= 'lower' )
                    // InternalRobotDSL.g:1442:4: enumLiteral_1= 'lower'
                    {
    ...
    // InternalRobotDSL.g:1452:1: ruleSoundName returns [Enumerator current=null] : ( (enumLiteral_0= 'buzz' ) | (enumLiteral_1= 'fanfare' ) ) ;
    public final Enumerator ruleSoundName() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1458:2: ( ( (enumLiteral_0= 'buzz' ) | (enumLiteral_1= 'fanfare' ) ) )
            // InternalRobotDSL.g:1459:2: ( (enumLiteral_0= 'buzz' ) | (enumLiteral_1= 'fanfare' ) )
            {
            // InternalRobotDSL.g:1459:2: ( (enumLiteral_0= 'buzz' ) | (enumLiteral_1= 'fanfare' ) )
            int alt24=2;
            ...
            switch (alt24) {
                case 1 :
                    // InternalRobotDSL.g:1460:3: (enumLiteral_0= 'buzz' )
                    {
                    // InternalRobotDSL.g:1460:3: (enumLiteral_0= 'buzz' )
                    // InternalRobotDSL.g:1461:4: enumLiteral_0= 'buzz'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1468:3: (enumLiteral_1= 'fanfare' )
                    {
                    // InternalRobotDSL.g:1468:3: (enumLiteral_1= 'fanfare' )
                    // InternalRobotDSL.g:1469:4: enumLiteral_1= 'fanfare'
                    {
    ...
    // InternalRobotDSL.g:1479:1: ruleSensorType returns [Enumerator current=null] : ( (enumLiteral_0= 'Color' ) | (enumLiteral_1= 'LeftLight' ) | (enumLiteral_2= 'RightLight' ) | (enumLiteral_3= 'RearHeight' ) | (enumLiteral_4= 'FrontDistance' ) | (enumLiteral_5= 'LeftTouch' ) | (enumLiteral_6= 'RightTouch' ) | (enumLiteral_7= 'Gyro' ) ) ;
    public final Enumerator ruleSensorType() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1485:2: ( ( (enumLiteral_0= 'Color' ) | (enumLiteral_1= 'LeftLight' ) | (enumLiteral_2= 'RightLight' ) | (enumLiteral_3= 'RearHeight' ) | (enumLiteral_4= 'FrontDistance' ) | (enumLiteral_5= 'LeftTouch' ) | (enumLiteral_6= 'RightTouch' ) | (enumLiteral_7= 'Gyro' ) ) )
            // InternalRobotDSL.g:1486:2: ( (enumLiteral_0= 'Color' ) | (enumLiteral_1= 'LeftLight' ) | (enumLiteral_2= 'RightLight' ) | (enumLiteral_3= 'RearHeight' ) | (enumLiteral_4= 'FrontDistance' ) | (enumLiteral_5= 'LeftTouch' ) | (enumLiteral_6= 'RightTouch' ) | (enumLiteral_7= 'Gyro' ) )
            {
            // InternalRobotDSL.g:1486:2: ( (enumLiteral_0= 'Color' ) | (enumLiteral_1= 'LeftLight' ) | (enumLiteral_2= 'RightLight' ) | (enumLiteral_3= 'RearHeight' ) | (enumLiteral_4= 'FrontDistance' ) | (enumLiteral_5= 'LeftTouch' ) | (enumLiteral_6= 'RightTouch' ) | (enumLiteral_7= 'Gyro' ) )
            int alt25=8;
            switch ( input.LA(1) ) {
            ...
            switch (alt25) {
                case 1 :
                    // InternalRobotDSL.g:1487:3: (enumLiteral_0= 'Color' )
                    {
                    // InternalRobotDSL.g:1487:3: (enumLiteral_0= 'Color' )
                    // InternalRobotDSL.g:1488:4: enumLiteral_0= 'Color'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1495:3: (enumLiteral_1= 'LeftLight' )
                    {
                    // InternalRobotDSL.g:1495:3: (enumLiteral_1= 'LeftLight' )
                    // InternalRobotDSL.g:1496:4: enumLiteral_1= 'LeftLight'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:1503:3: (enumLiteral_2= 'RightLight' )
                    {
                    // InternalRobotDSL.g:1503:3: (enumLiteral_2= 'RightLight' )
                    // InternalRobotDSL.g:1504:4: enumLiteral_2= 'RightLight'
                    {
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:1511:3: (enumLiteral_3= 'RearHeight' )
                    {
                    // InternalRobotDSL.g:1511:3: (enumLiteral_3= 'RearHeight' )
                    // InternalRobotDSL.g:1512:4: enumLiteral_3= 'RearHeight'
                    {
                    ...
                    break;
                case 5 :
                    // InternalRobotDSL.g:1519:3: (enumLiteral_4= 'FrontDistance' )
                    {
                    // InternalRobotDSL.g:1519:3: (enumLiteral_4= 'FrontDistance' )
                    // InternalRobotDSL.g:1520:4: enumLiteral_4= 'FrontDistance'
                    {
                    ...
                    break;
                case 6 :
                    // InternalRobotDSL.g:1527:3: (enumLiteral_5= 'LeftTouch' )
                    {
                    // InternalRobotDSL.g:1527:3: (enumLiteral_5= 'LeftTouch' )
                    // InternalRobotDSL.g:1528:4: enumLiteral_5= 'LeftTouch'
                    {
                    ...
                    break;
                case 7 :
                    // InternalRobotDSL.g:1535:3: (enumLiteral_6= 'RightTouch' )
                    {
                    // InternalRobotDSL.g:1535:3: (enumLiteral_6= 'RightTouch' )
                    // InternalRobotDSL.g:1536:4: enumLiteral_6= 'RightTouch'
                    {
                    ...
                    break;
                case 8 :
                    // InternalRobotDSL.g:1543:3: (enumLiteral_7= 'Gyro' )
                    {
                    // InternalRobotDSL.g:1543:3: (enumLiteral_7= 'Gyro' )
                    // InternalRobotDSL.g:1544:4: enumLiteral_7= 'Gyro'
                    {
    ...
    // InternalRobotDSL.g:1554:1: ruleColorName returns [Enumerator current=null] : ( (enumLiteral_0= 'red' ) | (enumLiteral_1= 'white' ) | (enumLiteral_2= 'black' ) | (enumLiteral_3= 'green' ) | (enumLiteral_4= 'blue' ) ) ;
    public final Enumerator ruleColorName() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1560:2: ( ( (enumLiteral_0= 'red' ) | (enumLiteral_1= 'white' ) | (enumLiteral_2= 'black' ) | (enumLiteral_3= 'green' ) | (enumLiteral_4= 'blue' ) ) )
            // InternalRobotDSL.g:1561:2: ( (enumLiteral_0= 'red' ) | (enumLiteral_1= 'white' ) | (enumLiteral_2= 'black' ) | (enumLiteral_3= 'green' ) | (enumLiteral_4= 'blue' ) )
            {
            // InternalRobotDSL.g:1561:2: ( (enumLiteral_0= 'red' ) | (enumLiteral_1= 'white' ) | (enumLiteral_2= 'black' ) | (enumLiteral_3= 'green' ) | (enumLiteral_4= 'blue' ) )
            int alt26=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt26) {
                case 1 :
                    // InternalRobotDSL.g:1562:3: (enumLiteral_0= 'red' )
                    {
                    // InternalRobotDSL.g:1562:3: (enumLiteral_0= 'red' )
                    // InternalRobotDSL.g:1563:4: enumLiteral_0= 'red'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1570:3: (enumLiteral_1= 'white' )
                    {
                    // InternalRobotDSL.g:1570:3: (enumLiteral_1= 'white' )
                    // InternalRobotDSL.g:1571:4: enumLiteral_1= 'white'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:1578:3: (enumLiteral_2= 'black' )
                    {
                    // InternalRobotDSL.g:1578:3: (enumLiteral_2= 'black' )
                    // InternalRobotDSL.g:1579:4: enumLiteral_2= 'black'
                    {
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:1586:3: (enumLiteral_3= 'green' )
                    {
                    // InternalRobotDSL.g:1586:3: (enumLiteral_3= 'green' )
                    // InternalRobotDSL.g:1587:4: enumLiteral_3= 'green'
                    {
                    ...
                    break;
                case 5 :
                    // InternalRobotDSL.g:1594:3: (enumLiteral_4= 'blue' )
                    {
                    // InternalRobotDSL.g:1594:3: (enumLiteral_4= 'blue' )
                    // InternalRobotDSL.g:1595:4: enumLiteral_4= 'blue'
                    {
    ...
    // InternalRobotDSL.g:1605:1: ruleBoolType returns [Enumerator current=null] : ( (enumLiteral_0= 'less' ) | (enumLiteral_1= 'greater' ) | (enumLiteral_2= 'and' ) | (enumLiteral_3= 'or' ) | (enumLiteral_4= 'true' ) | (enumLiteral_5= 'false' ) ) ;
    public final Enumerator ruleBoolType() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1611:2: ( ( (enumLiteral_0= 'less' ) | (enumLiteral_1= 'greater' ) | (enumLiteral_2= 'and' ) | (enumLiteral_3= 'or' ) | (enumLiteral_4= 'true' ) | (enumLiteral_5= 'false' ) ) )
            // InternalRobotDSL.g:1612:2: ( (enumLiteral_0= 'less' ) | (enumLiteral_1= 'greater' ) | (enumLiteral_2= 'and' ) | (enumLiteral_3= 'or' ) | (enumLiteral_4= 'true' ) | (enumLiteral_5= 'false' ) )
            {
            // InternalRobotDSL.g:1612:2: ( (enumLiteral_0= 'less' ) | (enumLiteral_1= 'greater' ) | (enumLiteral_2= 'and' ) | (enumLiteral_3= 'or' ) | (enumLiteral_4= 'true' ) | (enumLiteral_5= 'false' ) )
            int alt27=6;
            switch ( input.LA(1) ) {
            ...
            switch (alt27) {
                case 1 :
                    // InternalRobotDSL.g:1613:3: (enumLiteral_0= 'less' )
                    {
                    // InternalRobotDSL.g:1613:3: (enumLiteral_0= 'less' )
                    // InternalRobotDSL.g:1614:4: enumLiteral_0= 'less'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1621:3: (enumLiteral_1= 'greater' )
                    {
                    // InternalRobotDSL.g:1621:3: (enumLiteral_1= 'greater' )
                    // InternalRobotDSL.g:1622:4: enumLiteral_1= 'greater'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:1629:3: (enumLiteral_2= 'and' )
                    {
                    // InternalRobotDSL.g:1629:3: (enumLiteral_2= 'and' )
                    // InternalRobotDSL.g:1630:4: enumLiteral_2= 'and'
                    {
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:1637:3: (enumLiteral_3= 'or' )
                    {
                    // InternalRobotDSL.g:1637:3: (enumLiteral_3= 'or' )
                    // InternalRobotDSL.g:1638:4: enumLiteral_3= 'or'
                    {
                    ...
                    break;
                case 5 :
                    // InternalRobotDSL.g:1645:3: (enumLiteral_4= 'true' )
                    {
                    // InternalRobotDSL.g:1645:3: (enumLiteral_4= 'true' )
                    // InternalRobotDSL.g:1646:4: enumLiteral_4= 'true'
                    {
                    ...
                    break;
                case 6 :
                    // InternalRobotDSL.g:1653:3: (enumLiteral_5= 'false' )
                    {
                    // InternalRobotDSL.g:1653:3: (enumLiteral_5= 'false' )
                    // InternalRobotDSL.g:1654:4: enumLiteral_5= 'false'
                    {
    ...
    public static final BitSet FOLLOW_11 = new BitSet(new long[]{0x0000040000060000L});
    public static final BitSet FOLLOW_12 = new BitSet(new long[]{0xFF00100000000010L,0x00000000000007E0L});
    public static final BitSet FOLLOW_13 = new BitSet(new long[]{0xFF00140000040012L,0x00000000000007E0L});
    ...
    public static final BitSet FOLLOW_20 = new BitSet(new long[]{0xFF00100000040010L,0x00000000000007E0L});
    ...
    public static final BitSet FOLLOW_29 = new BitSet(new long[]{0xFF00100000000012L,0x00000000000007E0L});
    public static final BitSet FOLLOW_30 = new BitSet(new long[]{0x0030000000000000L});
    public static final BitSet FOLLOW_31 = new BitSet(new long[]{0x0000000100000000L});
    public static final BitSet FOLLOW_32 = new BitSet(new long[]{0x00C0000000000000L});
