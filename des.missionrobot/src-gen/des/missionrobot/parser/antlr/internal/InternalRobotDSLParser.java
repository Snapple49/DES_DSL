...
public class InternalRobotDSLParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'Missionset'", "'Missions:'", "'Mission'", "'Flags:'", "'Tasks:'", "'Goal:'", "'Condition:'", "'Actions:'", "'Task:'", "'priority:'", "'Triggers:'", "'Move'", "'for'", "'milisec'", "'at'", "'speed'", "'Turn'", "'deg'", "'until'", "'Arm'", "'Play'", "'sound'", "'Update'", "'to'", "'Centalize'", "'is'", "'distance'", "'than'", "'cm'", "'Time:'", "'sec'", "'not'", "'forward'", "'backward'", "'left'", "'right'", "'high'", "'medium'", "'low'", "'raise'", "'lower'", "'buzz'", "'fanfare'", "'Color'", "'LeftLight'", "'RightLight'", "'RearHeight'", "'FrontDistance'", "'LeftTouch'", "'RightTouch'", "'Gyro'", "'red'", "'white'", "'black'", "'green'", "'blue'", "'less'", "'greater'", "'and'", "'or'", "'true'", "'false'"
    };
            ...
            switch (alt5) {
                case 1 :
                    ...
                    do {
                        ...
                        if ( (LA4_0==RULE_ID||LA4_0==42||(LA4_0>=54 && LA4_0<=61)||(LA4_0>=67 && LA4_0<=72)) ) {
                            alt4=1;
                        }
            ...
            switch (alt10) {
                case 1 :
                    ...
                    do {
                        ...
                        if ( (LA9_0==RULE_ID||LA9_0==42||(LA9_0>=54 && LA9_0<=61)||(LA9_0>=67 && LA9_0<=72)) ) {
                            alt9=1;
                        }
    ...
    public final EObject ruleAction() throws RecognitionException {
        ...
        try {
            ...
            switch (alt16) {
                case 1 :
                    // InternalRobotDSL.g:453:3: (otherlv_0= 'Move' ( (lv_moveDir_1_0= ruleDirection ) ) (otherlv_2= 'for' ( (lv_duration_3_0= RULE_INT ) ) otherlv_4= 'milisec' )? (otherlv_5= 'at' ( (lv_speed_6_0= ruleSpeed ) ) otherlv_7= 'speed' )? )
                    {
                    // InternalRobotDSL.g:453:3: (otherlv_0= 'Move' ( (lv_moveDir_1_0= ruleDirection ) ) (otherlv_2= 'for' ( (lv_duration_3_0= RULE_INT ) ) otherlv_4= 'milisec' )? (otherlv_5= 'at' ( (lv_speed_6_0= ruleSpeed ) ) otherlv_7= 'speed' )? )
                    // InternalRobotDSL.g:454:4: otherlv_0= 'Move' ( (lv_moveDir_1_0= ruleDirection ) ) (otherlv_2= 'for' ( (lv_duration_3_0= RULE_INT ) ) otherlv_4= 'milisec' )? (otherlv_5= 'at' ( (lv_speed_6_0= ruleSpeed ) ) otherlv_7= 'speed' )?
                    {
                    ...
                    // InternalRobotDSL.g:477:4: (otherlv_2= 'for' ( (lv_duration_3_0= RULE_INT ) ) otherlv_4= 'milisec' )?
                    int alt12=2;
                    ...
                    switch (alt12) {
                        case 1 :
                            // InternalRobotDSL.g:478:5: otherlv_2= 'for' ( (lv_duration_3_0= RULE_INT ) ) otherlv_4= 'milisec'
                            {
                    ...
                    switch (alt15) {
                        ...
                        case 2 :
                            ...
                            do {
                                ...
                                if ( (LA14_0==RULE_ID||LA14_0==42||(LA14_0>=54 && LA14_0<=61)||(LA14_0>=67 && LA14_0<=72)) ) {
                                    alt14=1;
                                }
    ...
    // InternalRobotDSL.g:738:1: ruleTrigger returns [EObject current=null] : ( ( (lv_boolType_0_0= ruleBool ) )? ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) ) ) ) ) ;
    public final EObject ruleTrigger() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:744:2: ( ( ( (lv_boolType_0_0= ruleBool ) )? ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) ) ) ) ) )
            // InternalRobotDSL.g:745:2: ( ( (lv_boolType_0_0= ruleBool ) )? ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) ) ) ) )
            {
            // InternalRobotDSL.g:745:2: ( ( (lv_boolType_0_0= ruleBool ) )? ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) ) ) ) )
            // InternalRobotDSL.g:746:3: ( (lv_boolType_0_0= ruleBool ) )? ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) ) ) )
            {
            // InternalRobotDSL.g:746:3: ( (lv_boolType_0_0= ruleBool ) )?
            int alt17=2;
            int LA17_0 = input.LA(1);

            if ( ((LA17_0>=67 && LA17_0<=72)) ) {
                alt17=1;
            }
            switch (alt17) {
                case 1 :
            ...
            // InternalRobotDSL.g:765:3: ( ( ( (lv_neg_1_0= ruleNegation ) )? ( (otherlv_2= RULE_ID ) ) ) | ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) ) ) )
            int alt20=2;
            ...
            switch (alt20) {
                case 1 :
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:801:4: ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) ) )
                    {
                    // InternalRobotDSL.g:801:4: ( ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) ) )
                    // InternalRobotDSL.g:802:5: ( (lv_sensor_3_0= ruleSensor ) ) ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) )
                    {
                    ...
                    // InternalRobotDSL.g:821:5: ( (otherlv_4= 'is' ( (lv_color_5_0= ruleColor ) ) ) | (otherlv_6= 'distance' ( (lv_dist_7_0= ruleDistance ) ) ) )
                    int alt19=2;
    ...
    // InternalRobotDSL.g:880:1: entryRuleDistance returns [EObject current=null] : iv_ruleDistance= ruleDistance EOF ;
    public final EObject entryRuleDistance() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:880:49: (iv_ruleDistance= ruleDistance EOF )
            // InternalRobotDSL.g:881:2: iv_ruleDistance= ruleDistance EOF
            {
    ...
    // InternalRobotDSL.g:887:1: ruleDistance returns [EObject current=null] : ( ( (lv_rangeBool_0_0= ruleBool ) ) otherlv_1= 'than' ( (lv_distance_2_0= RULE_INT ) ) otherlv_3= 'cm' ) ;
    public final EObject ruleDistance() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:893:2: ( ( ( (lv_rangeBool_0_0= ruleBool ) ) otherlv_1= 'than' ( (lv_distance_2_0= RULE_INT ) ) otherlv_3= 'cm' ) )
            // InternalRobotDSL.g:894:2: ( ( (lv_rangeBool_0_0= ruleBool ) ) otherlv_1= 'than' ( (lv_distance_2_0= RULE_INT ) ) otherlv_3= 'cm' )
            {
            // InternalRobotDSL.g:894:2: ( ( (lv_rangeBool_0_0= ruleBool ) ) otherlv_1= 'than' ( (lv_distance_2_0= RULE_INT ) ) otherlv_3= 'cm' )
            // InternalRobotDSL.g:895:3: ( (lv_rangeBool_0_0= ruleBool ) ) otherlv_1= 'than' ( (lv_distance_2_0= RULE_INT ) ) otherlv_3= 'cm'
            {
            // InternalRobotDSL.g:895:3: ( (lv_rangeBool_0_0= ruleBool ) )
            // InternalRobotDSL.g:896:4: (lv_rangeBool_0_0= ruleBool )
            {
            // InternalRobotDSL.g:896:4: (lv_rangeBool_0_0= ruleBool )
            // InternalRobotDSL.g:897:5: lv_rangeBool_0_0= ruleBool
            {
            ...
            // InternalRobotDSL.g:918:3: ( (lv_distance_2_0= RULE_INT ) )
            // InternalRobotDSL.g:919:4: (lv_distance_2_0= RULE_INT )
            {
            // InternalRobotDSL.g:919:4: (lv_distance_2_0= RULE_INT )
            // InternalRobotDSL.g:920:5: lv_distance_2_0= RULE_INT
            {
    ...
    // InternalRobotDSL.g:944:1: entryRuleFlag returns [EObject current=null] : iv_ruleFlag= ruleFlag EOF ;
    public final EObject entryRuleFlag() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:944:45: (iv_ruleFlag= ruleFlag EOF )
            // InternalRobotDSL.g:945:2: iv_ruleFlag= ruleFlag EOF
            {
    ...
    // InternalRobotDSL.g:951:1: ruleFlag returns [EObject current=null] : ( (lv_name_0_0= RULE_ID ) ) ;
    public final EObject ruleFlag() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:957:2: ( ( (lv_name_0_0= RULE_ID ) ) )
            // InternalRobotDSL.g:958:2: ( (lv_name_0_0= RULE_ID ) )
            {
            // InternalRobotDSL.g:958:2: ( (lv_name_0_0= RULE_ID ) )
            // InternalRobotDSL.g:959:3: (lv_name_0_0= RULE_ID )
            {
            // InternalRobotDSL.g:959:3: (lv_name_0_0= RULE_ID )
            // InternalRobotDSL.g:960:4: lv_name_0_0= RULE_ID
            {
    ...
    // InternalRobotDSL.g:979:1: entryRuleTime returns [EObject current=null] : iv_ruleTime= ruleTime EOF ;
    public final EObject entryRuleTime() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:979:45: (iv_ruleTime= ruleTime EOF )
            // InternalRobotDSL.g:980:2: iv_ruleTime= ruleTime EOF
            {
    ...
    // InternalRobotDSL.g:986:1: ruleTime returns [EObject current=null] : (otherlv_0= 'Time:' ( (lv_sec_1_0= RULE_INT ) ) otherlv_2= 'sec' ) ;
    public final EObject ruleTime() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:992:2: ( (otherlv_0= 'Time:' ( (lv_sec_1_0= RULE_INT ) ) otherlv_2= 'sec' ) )
            // InternalRobotDSL.g:993:2: (otherlv_0= 'Time:' ( (lv_sec_1_0= RULE_INT ) ) otherlv_2= 'sec' )
            {
            // InternalRobotDSL.g:993:2: (otherlv_0= 'Time:' ( (lv_sec_1_0= RULE_INT ) ) otherlv_2= 'sec' )
            // InternalRobotDSL.g:994:3: otherlv_0= 'Time:' ( (lv_sec_1_0= RULE_INT ) ) otherlv_2= 'sec'
            {
            otherlv_0=(Token)match(input,40,FOLLOW_18); 

            			newLeafNode(otherlv_0, grammarAccess.getTimeAccess().getTimeKeyword_0());
            		
            // InternalRobotDSL.g:998:3: ( (lv_sec_1_0= RULE_INT ) )
            // InternalRobotDSL.g:999:4: (lv_sec_1_0= RULE_INT )
            {
            // InternalRobotDSL.g:999:4: (lv_sec_1_0= RULE_INT )
            // InternalRobotDSL.g:1000:5: lv_sec_1_0= RULE_INT
            {
    ...
    // InternalRobotDSL.g:1024:1: entryRuleDirection returns [EObject current=null] : iv_ruleDirection= ruleDirection EOF ;
    public final EObject entryRuleDirection() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1024:50: (iv_ruleDirection= ruleDirection EOF )
            // InternalRobotDSL.g:1025:2: iv_ruleDirection= ruleDirection EOF
            {
    ...
    // InternalRobotDSL.g:1031:1: ruleDirection returns [EObject current=null] : ( (lv_dir_0_0= ruleDirectionVal ) ) ;
    public final EObject ruleDirection() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1037:2: ( ( (lv_dir_0_0= ruleDirectionVal ) ) )
            // InternalRobotDSL.g:1038:2: ( (lv_dir_0_0= ruleDirectionVal ) )
            {
            // InternalRobotDSL.g:1038:2: ( (lv_dir_0_0= ruleDirectionVal ) )
            // InternalRobotDSL.g:1039:3: (lv_dir_0_0= ruleDirectionVal )
            {
            // InternalRobotDSL.g:1039:3: (lv_dir_0_0= ruleDirectionVal )
            // InternalRobotDSL.g:1040:4: lv_dir_0_0= ruleDirectionVal
            {
    ...
    // InternalRobotDSL.g:1060:1: entryRuleSpeed returns [EObject current=null] : iv_ruleSpeed= ruleSpeed EOF ;
    public final EObject entryRuleSpeed() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1060:46: (iv_ruleSpeed= ruleSpeed EOF )
            // InternalRobotDSL.g:1061:2: iv_ruleSpeed= ruleSpeed EOF
            {
    ...
    // InternalRobotDSL.g:1067:1: ruleSpeed returns [EObject current=null] : ( (lv_speed_0_0= ruleSpeedVal ) ) ;
    public final EObject ruleSpeed() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1073:2: ( ( (lv_speed_0_0= ruleSpeedVal ) ) )
            // InternalRobotDSL.g:1074:2: ( (lv_speed_0_0= ruleSpeedVal ) )
            {
            // InternalRobotDSL.g:1074:2: ( (lv_speed_0_0= ruleSpeedVal ) )
            // InternalRobotDSL.g:1075:3: (lv_speed_0_0= ruleSpeedVal )
            {
            // InternalRobotDSL.g:1075:3: (lv_speed_0_0= ruleSpeedVal )
            // InternalRobotDSL.g:1076:4: lv_speed_0_0= ruleSpeedVal
            {
    ...
    // InternalRobotDSL.g:1096:1: entryRuleArmOp returns [EObject current=null] : iv_ruleArmOp= ruleArmOp EOF ;
    public final EObject entryRuleArmOp() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1096:46: (iv_ruleArmOp= ruleArmOp EOF )
            // InternalRobotDSL.g:1097:2: iv_ruleArmOp= ruleArmOp EOF
            {
    ...
    // InternalRobotDSL.g:1103:1: ruleArmOp returns [EObject current=null] : ( (lv_opType_0_0= ruleArmOpType ) ) ;
    public final EObject ruleArmOp() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1109:2: ( ( (lv_opType_0_0= ruleArmOpType ) ) )
            // InternalRobotDSL.g:1110:2: ( (lv_opType_0_0= ruleArmOpType ) )
            {
            // InternalRobotDSL.g:1110:2: ( (lv_opType_0_0= ruleArmOpType ) )
            // InternalRobotDSL.g:1111:3: (lv_opType_0_0= ruleArmOpType )
            {
            // InternalRobotDSL.g:1111:3: (lv_opType_0_0= ruleArmOpType )
            // InternalRobotDSL.g:1112:4: lv_opType_0_0= ruleArmOpType
            {
    ...
    // InternalRobotDSL.g:1132:1: entryRuleSound returns [EObject current=null] : iv_ruleSound= ruleSound EOF ;
    public final EObject entryRuleSound() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1132:46: (iv_ruleSound= ruleSound EOF )
            // InternalRobotDSL.g:1133:2: iv_ruleSound= ruleSound EOF
            {
    ...
    // InternalRobotDSL.g:1139:1: ruleSound returns [EObject current=null] : ( (lv_soundName_0_0= ruleSoundName ) ) ;
    public final EObject ruleSound() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1145:2: ( ( (lv_soundName_0_0= ruleSoundName ) ) )
            // InternalRobotDSL.g:1146:2: ( (lv_soundName_0_0= ruleSoundName ) )
            {
            // InternalRobotDSL.g:1146:2: ( (lv_soundName_0_0= ruleSoundName ) )
            // InternalRobotDSL.g:1147:3: (lv_soundName_0_0= ruleSoundName )
            {
            // InternalRobotDSL.g:1147:3: (lv_soundName_0_0= ruleSoundName )
            // InternalRobotDSL.g:1148:4: lv_soundName_0_0= ruleSoundName
            {
    ...
    // InternalRobotDSL.g:1168:1: entryRuleSensor returns [EObject current=null] : iv_ruleSensor= ruleSensor EOF ;
    public final EObject entryRuleSensor() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1168:47: (iv_ruleSensor= ruleSensor EOF )
            // InternalRobotDSL.g:1169:2: iv_ruleSensor= ruleSensor EOF
            {
    ...
    // InternalRobotDSL.g:1175:1: ruleSensor returns [EObject current=null] : ( (lv_sensorType_0_0= ruleSensorType ) ) ;
    public final EObject ruleSensor() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1181:2: ( ( (lv_sensorType_0_0= ruleSensorType ) ) )
            // InternalRobotDSL.g:1182:2: ( (lv_sensorType_0_0= ruleSensorType ) )
            {
            // InternalRobotDSL.g:1182:2: ( (lv_sensorType_0_0= ruleSensorType ) )
            // InternalRobotDSL.g:1183:3: (lv_sensorType_0_0= ruleSensorType )
            {
            // InternalRobotDSL.g:1183:3: (lv_sensorType_0_0= ruleSensorType )
            // InternalRobotDSL.g:1184:4: lv_sensorType_0_0= ruleSensorType
            {
    ...
    // InternalRobotDSL.g:1204:1: entryRuleColor returns [EObject current=null] : iv_ruleColor= ruleColor EOF ;
    public final EObject entryRuleColor() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1204:46: (iv_ruleColor= ruleColor EOF )
            // InternalRobotDSL.g:1205:2: iv_ruleColor= ruleColor EOF
            {
    ...
    // InternalRobotDSL.g:1211:1: ruleColor returns [EObject current=null] : ( (lv_colorName_0_0= ruleColorName ) ) ;
    public final EObject ruleColor() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1217:2: ( ( (lv_colorName_0_0= ruleColorName ) ) )
            // InternalRobotDSL.g:1218:2: ( (lv_colorName_0_0= ruleColorName ) )
            {
            // InternalRobotDSL.g:1218:2: ( (lv_colorName_0_0= ruleColorName ) )
            // InternalRobotDSL.g:1219:3: (lv_colorName_0_0= ruleColorName )
            {
            // InternalRobotDSL.g:1219:3: (lv_colorName_0_0= ruleColorName )
            // InternalRobotDSL.g:1220:4: lv_colorName_0_0= ruleColorName
            {
    ...
    // InternalRobotDSL.g:1240:1: entryRuleBool returns [EObject current=null] : iv_ruleBool= ruleBool EOF ;
    public final EObject entryRuleBool() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1240:45: (iv_ruleBool= ruleBool EOF )
            // InternalRobotDSL.g:1241:2: iv_ruleBool= ruleBool EOF
            {
    ...
    // InternalRobotDSL.g:1247:1: ruleBool returns [EObject current=null] : ( (lv_boolType_0_0= ruleBoolType ) ) ;
    public final EObject ruleBool() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1253:2: ( ( (lv_boolType_0_0= ruleBoolType ) ) )
            // InternalRobotDSL.g:1254:2: ( (lv_boolType_0_0= ruleBoolType ) )
            {
            // InternalRobotDSL.g:1254:2: ( (lv_boolType_0_0= ruleBoolType ) )
            // InternalRobotDSL.g:1255:3: (lv_boolType_0_0= ruleBoolType )
            {
            // InternalRobotDSL.g:1255:3: (lv_boolType_0_0= ruleBoolType )
            // InternalRobotDSL.g:1256:4: lv_boolType_0_0= ruleBoolType
            {
    ...
    // InternalRobotDSL.g:1276:1: entryRuleNegation returns [EObject current=null] : iv_ruleNegation= ruleNegation EOF ;
    public final EObject entryRuleNegation() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1276:49: (iv_ruleNegation= ruleNegation EOF )
            // InternalRobotDSL.g:1277:2: iv_ruleNegation= ruleNegation EOF
            {
    ...
    // InternalRobotDSL.g:1283:1: ruleNegation returns [EObject current=null] : ( (lv_NOT_0_0= 'not' ) ) ;
    public final EObject ruleNegation() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1289:2: ( ( (lv_NOT_0_0= 'not' ) ) )
            // InternalRobotDSL.g:1290:2: ( (lv_NOT_0_0= 'not' ) )
            {
            // InternalRobotDSL.g:1290:2: ( (lv_NOT_0_0= 'not' ) )
            // InternalRobotDSL.g:1291:3: (lv_NOT_0_0= 'not' )
            {
            // InternalRobotDSL.g:1291:3: (lv_NOT_0_0= 'not' )
            // InternalRobotDSL.g:1292:4: lv_NOT_0_0= 'not'
            {
    ...
    // InternalRobotDSL.g:1307:1: ruleDirectionVal returns [Enumerator current=null] : ( (enumLiteral_0= 'forward' ) | (enumLiteral_1= 'backward' ) | (enumLiteral_2= 'left' ) | (enumLiteral_3= 'right' ) ) ;
    public final Enumerator ruleDirectionVal() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1313:2: ( ( (enumLiteral_0= 'forward' ) | (enumLiteral_1= 'backward' ) | (enumLiteral_2= 'left' ) | (enumLiteral_3= 'right' ) ) )
            // InternalRobotDSL.g:1314:2: ( (enumLiteral_0= 'forward' ) | (enumLiteral_1= 'backward' ) | (enumLiteral_2= 'left' ) | (enumLiteral_3= 'right' ) )
            {
            // InternalRobotDSL.g:1314:2: ( (enumLiteral_0= 'forward' ) | (enumLiteral_1= 'backward' ) | (enumLiteral_2= 'left' ) | (enumLiteral_3= 'right' ) )
            int alt21=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt21) {
                case 1 :
                    // InternalRobotDSL.g:1315:3: (enumLiteral_0= 'forward' )
                    {
                    // InternalRobotDSL.g:1315:3: (enumLiteral_0= 'forward' )
                    // InternalRobotDSL.g:1316:4: enumLiteral_0= 'forward'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1323:3: (enumLiteral_1= 'backward' )
                    {
                    // InternalRobotDSL.g:1323:3: (enumLiteral_1= 'backward' )
                    // InternalRobotDSL.g:1324:4: enumLiteral_1= 'backward'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:1331:3: (enumLiteral_2= 'left' )
                    {
                    // InternalRobotDSL.g:1331:3: (enumLiteral_2= 'left' )
                    // InternalRobotDSL.g:1332:4: enumLiteral_2= 'left'
                    {
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:1339:3: (enumLiteral_3= 'right' )
                    {
                    // InternalRobotDSL.g:1339:3: (enumLiteral_3= 'right' )
                    // InternalRobotDSL.g:1340:4: enumLiteral_3= 'right'
                    {
    ...
    // InternalRobotDSL.g:1350:1: ruleSpeedVal returns [Enumerator current=null] : ( (enumLiteral_0= 'high' ) | (enumLiteral_1= 'medium' ) | (enumLiteral_2= 'low' ) ) ;
    public final Enumerator ruleSpeedVal() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1356:2: ( ( (enumLiteral_0= 'high' ) | (enumLiteral_1= 'medium' ) | (enumLiteral_2= 'low' ) ) )
            // InternalRobotDSL.g:1357:2: ( (enumLiteral_0= 'high' ) | (enumLiteral_1= 'medium' ) | (enumLiteral_2= 'low' ) )
            {
            // InternalRobotDSL.g:1357:2: ( (enumLiteral_0= 'high' ) | (enumLiteral_1= 'medium' ) | (enumLiteral_2= 'low' ) )
            int alt22=3;
            switch ( input.LA(1) ) {
            ...
            switch (alt22) {
                case 1 :
                    // InternalRobotDSL.g:1358:3: (enumLiteral_0= 'high' )
                    {
                    // InternalRobotDSL.g:1358:3: (enumLiteral_0= 'high' )
                    // InternalRobotDSL.g:1359:4: enumLiteral_0= 'high'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1366:3: (enumLiteral_1= 'medium' )
                    {
                    // InternalRobotDSL.g:1366:3: (enumLiteral_1= 'medium' )
                    // InternalRobotDSL.g:1367:4: enumLiteral_1= 'medium'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:1374:3: (enumLiteral_2= 'low' )
                    {
                    // InternalRobotDSL.g:1374:3: (enumLiteral_2= 'low' )
                    // InternalRobotDSL.g:1375:4: enumLiteral_2= 'low'
                    {
    ...
    // InternalRobotDSL.g:1385:1: ruleArmOpType returns [Enumerator current=null] : ( (enumLiteral_0= 'raise' ) | (enumLiteral_1= 'lower' ) ) ;
    public final Enumerator ruleArmOpType() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1391:2: ( ( (enumLiteral_0= 'raise' ) | (enumLiteral_1= 'lower' ) ) )
            // InternalRobotDSL.g:1392:2: ( (enumLiteral_0= 'raise' ) | (enumLiteral_1= 'lower' ) )
            {
            // InternalRobotDSL.g:1392:2: ( (enumLiteral_0= 'raise' ) | (enumLiteral_1= 'lower' ) )
            int alt23=2;
            ...
            switch (alt23) {
                case 1 :
                    // InternalRobotDSL.g:1393:3: (enumLiteral_0= 'raise' )
                    {
                    // InternalRobotDSL.g:1393:3: (enumLiteral_0= 'raise' )
                    // InternalRobotDSL.g:1394:4: enumLiteral_0= 'raise'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1401:3: (enumLiteral_1= 'lower' )
                    {
                    // InternalRobotDSL.g:1401:3: (enumLiteral_1= 'lower' )
                    // InternalRobotDSL.g:1402:4: enumLiteral_1= 'lower'
                    {
    ...
    // InternalRobotDSL.g:1412:1: ruleSoundName returns [Enumerator current=null] : ( (enumLiteral_0= 'buzz' ) | (enumLiteral_1= 'fanfare' ) ) ;
    public final Enumerator ruleSoundName() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1418:2: ( ( (enumLiteral_0= 'buzz' ) | (enumLiteral_1= 'fanfare' ) ) )
            // InternalRobotDSL.g:1419:2: ( (enumLiteral_0= 'buzz' ) | (enumLiteral_1= 'fanfare' ) )
            {
            // InternalRobotDSL.g:1419:2: ( (enumLiteral_0= 'buzz' ) | (enumLiteral_1= 'fanfare' ) )
            int alt24=2;
            ...
            switch (alt24) {
                case 1 :
                    // InternalRobotDSL.g:1420:3: (enumLiteral_0= 'buzz' )
                    {
                    // InternalRobotDSL.g:1420:3: (enumLiteral_0= 'buzz' )
                    // InternalRobotDSL.g:1421:4: enumLiteral_0= 'buzz'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1428:3: (enumLiteral_1= 'fanfare' )
                    {
                    // InternalRobotDSL.g:1428:3: (enumLiteral_1= 'fanfare' )
                    // InternalRobotDSL.g:1429:4: enumLiteral_1= 'fanfare'
                    {
    ...
    // InternalRobotDSL.g:1439:1: ruleSensorType returns [Enumerator current=null] : ( (enumLiteral_0= 'Color' ) | (enumLiteral_1= 'LeftLight' ) | (enumLiteral_2= 'RightLight' ) | (enumLiteral_3= 'RearHeight' ) | (enumLiteral_4= 'FrontDistance' ) | (enumLiteral_5= 'LeftTouch' ) | (enumLiteral_6= 'RightTouch' ) | (enumLiteral_7= 'Gyro' ) ) ;
    public final Enumerator ruleSensorType() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1445:2: ( ( (enumLiteral_0= 'Color' ) | (enumLiteral_1= 'LeftLight' ) | (enumLiteral_2= 'RightLight' ) | (enumLiteral_3= 'RearHeight' ) | (enumLiteral_4= 'FrontDistance' ) | (enumLiteral_5= 'LeftTouch' ) | (enumLiteral_6= 'RightTouch' ) | (enumLiteral_7= 'Gyro' ) ) )
            // InternalRobotDSL.g:1446:2: ( (enumLiteral_0= 'Color' ) | (enumLiteral_1= 'LeftLight' ) | (enumLiteral_2= 'RightLight' ) | (enumLiteral_3= 'RearHeight' ) | (enumLiteral_4= 'FrontDistance' ) | (enumLiteral_5= 'LeftTouch' ) | (enumLiteral_6= 'RightTouch' ) | (enumLiteral_7= 'Gyro' ) )
            {
            // InternalRobotDSL.g:1446:2: ( (enumLiteral_0= 'Color' ) | (enumLiteral_1= 'LeftLight' ) | (enumLiteral_2= 'RightLight' ) | (enumLiteral_3= 'RearHeight' ) | (enumLiteral_4= 'FrontDistance' ) | (enumLiteral_5= 'LeftTouch' ) | (enumLiteral_6= 'RightTouch' ) | (enumLiteral_7= 'Gyro' ) )
            int alt25=8;
            switch ( input.LA(1) ) {
            ...
            switch (alt25) {
                case 1 :
                    // InternalRobotDSL.g:1447:3: (enumLiteral_0= 'Color' )
                    {
                    // InternalRobotDSL.g:1447:3: (enumLiteral_0= 'Color' )
                    // InternalRobotDSL.g:1448:4: enumLiteral_0= 'Color'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1455:3: (enumLiteral_1= 'LeftLight' )
                    {
                    // InternalRobotDSL.g:1455:3: (enumLiteral_1= 'LeftLight' )
                    // InternalRobotDSL.g:1456:4: enumLiteral_1= 'LeftLight'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:1463:3: (enumLiteral_2= 'RightLight' )
                    {
                    // InternalRobotDSL.g:1463:3: (enumLiteral_2= 'RightLight' )
                    // InternalRobotDSL.g:1464:4: enumLiteral_2= 'RightLight'
                    {
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:1471:3: (enumLiteral_3= 'RearHeight' )
                    {
                    // InternalRobotDSL.g:1471:3: (enumLiteral_3= 'RearHeight' )
                    // InternalRobotDSL.g:1472:4: enumLiteral_3= 'RearHeight'
                    {
                    ...
                    break;
                case 5 :
                    // InternalRobotDSL.g:1479:3: (enumLiteral_4= 'FrontDistance' )
                    {
                    // InternalRobotDSL.g:1479:3: (enumLiteral_4= 'FrontDistance' )
                    // InternalRobotDSL.g:1480:4: enumLiteral_4= 'FrontDistance'
                    {
                    ...
                    break;
                case 6 :
                    // InternalRobotDSL.g:1487:3: (enumLiteral_5= 'LeftTouch' )
                    {
                    // InternalRobotDSL.g:1487:3: (enumLiteral_5= 'LeftTouch' )
                    // InternalRobotDSL.g:1488:4: enumLiteral_5= 'LeftTouch'
                    {
                    ...
                    break;
                case 7 :
                    // InternalRobotDSL.g:1495:3: (enumLiteral_6= 'RightTouch' )
                    {
                    // InternalRobotDSL.g:1495:3: (enumLiteral_6= 'RightTouch' )
                    // InternalRobotDSL.g:1496:4: enumLiteral_6= 'RightTouch'
                    {
                    ...
                    break;
                case 8 :
                    // InternalRobotDSL.g:1503:3: (enumLiteral_7= 'Gyro' )
                    {
                    // InternalRobotDSL.g:1503:3: (enumLiteral_7= 'Gyro' )
                    // InternalRobotDSL.g:1504:4: enumLiteral_7= 'Gyro'
                    {
    ...
    // InternalRobotDSL.g:1514:1: ruleColorName returns [Enumerator current=null] : ( (enumLiteral_0= 'red' ) | (enumLiteral_1= 'white' ) | (enumLiteral_2= 'black' ) | (enumLiteral_3= 'green' ) | (enumLiteral_4= 'blue' ) ) ;
    public final Enumerator ruleColorName() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1520:2: ( ( (enumLiteral_0= 'red' ) | (enumLiteral_1= 'white' ) | (enumLiteral_2= 'black' ) | (enumLiteral_3= 'green' ) | (enumLiteral_4= 'blue' ) ) )
            // InternalRobotDSL.g:1521:2: ( (enumLiteral_0= 'red' ) | (enumLiteral_1= 'white' ) | (enumLiteral_2= 'black' ) | (enumLiteral_3= 'green' ) | (enumLiteral_4= 'blue' ) )
            {
            // InternalRobotDSL.g:1521:2: ( (enumLiteral_0= 'red' ) | (enumLiteral_1= 'white' ) | (enumLiteral_2= 'black' ) | (enumLiteral_3= 'green' ) | (enumLiteral_4= 'blue' ) )
            int alt26=5;
            switch ( input.LA(1) ) {
            ...
            switch (alt26) {
                case 1 :
                    // InternalRobotDSL.g:1522:3: (enumLiteral_0= 'red' )
                    {
                    // InternalRobotDSL.g:1522:3: (enumLiteral_0= 'red' )
                    // InternalRobotDSL.g:1523:4: enumLiteral_0= 'red'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1530:3: (enumLiteral_1= 'white' )
                    {
                    // InternalRobotDSL.g:1530:3: (enumLiteral_1= 'white' )
                    // InternalRobotDSL.g:1531:4: enumLiteral_1= 'white'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:1538:3: (enumLiteral_2= 'black' )
                    {
                    // InternalRobotDSL.g:1538:3: (enumLiteral_2= 'black' )
                    // InternalRobotDSL.g:1539:4: enumLiteral_2= 'black'
                    {
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:1546:3: (enumLiteral_3= 'green' )
                    {
                    // InternalRobotDSL.g:1546:3: (enumLiteral_3= 'green' )
                    // InternalRobotDSL.g:1547:4: enumLiteral_3= 'green'
                    {
                    ...
                    break;
                case 5 :
                    // InternalRobotDSL.g:1554:3: (enumLiteral_4= 'blue' )
                    {
                    // InternalRobotDSL.g:1554:3: (enumLiteral_4= 'blue' )
                    // InternalRobotDSL.g:1555:4: enumLiteral_4= 'blue'
                    {
    ...
    // InternalRobotDSL.g:1565:1: ruleBoolType returns [Enumerator current=null] : ( (enumLiteral_0= 'less' ) | (enumLiteral_1= 'greater' ) | (enumLiteral_2= 'and' ) | (enumLiteral_3= 'or' ) | (enumLiteral_4= 'true' ) | (enumLiteral_5= 'false' ) ) ;
    public final Enumerator ruleBoolType() throws RecognitionException {
        ...
        try {
            // InternalRobotDSL.g:1571:2: ( ( (enumLiteral_0= 'less' ) | (enumLiteral_1= 'greater' ) | (enumLiteral_2= 'and' ) | (enumLiteral_3= 'or' ) | (enumLiteral_4= 'true' ) | (enumLiteral_5= 'false' ) ) )
            // InternalRobotDSL.g:1572:2: ( (enumLiteral_0= 'less' ) | (enumLiteral_1= 'greater' ) | (enumLiteral_2= 'and' ) | (enumLiteral_3= 'or' ) | (enumLiteral_4= 'true' ) | (enumLiteral_5= 'false' ) )
            {
            // InternalRobotDSL.g:1572:2: ( (enumLiteral_0= 'less' ) | (enumLiteral_1= 'greater' ) | (enumLiteral_2= 'and' ) | (enumLiteral_3= 'or' ) | (enumLiteral_4= 'true' ) | (enumLiteral_5= 'false' ) )
            int alt27=6;
            switch ( input.LA(1) ) {
            ...
            switch (alt27) {
                case 1 :
                    // InternalRobotDSL.g:1573:3: (enumLiteral_0= 'less' )
                    {
                    // InternalRobotDSL.g:1573:3: (enumLiteral_0= 'less' )
                    // InternalRobotDSL.g:1574:4: enumLiteral_0= 'less'
                    {
                    ...
                    break;
                case 2 :
                    // InternalRobotDSL.g:1581:3: (enumLiteral_1= 'greater' )
                    {
                    // InternalRobotDSL.g:1581:3: (enumLiteral_1= 'greater' )
                    // InternalRobotDSL.g:1582:4: enumLiteral_1= 'greater'
                    {
                    ...
                    break;
                case 3 :
                    // InternalRobotDSL.g:1589:3: (enumLiteral_2= 'and' )
                    {
                    // InternalRobotDSL.g:1589:3: (enumLiteral_2= 'and' )
                    // InternalRobotDSL.g:1590:4: enumLiteral_2= 'and'
                    {
                    ...
                    break;
                case 4 :
                    // InternalRobotDSL.g:1597:3: (enumLiteral_3= 'or' )
                    {
                    // InternalRobotDSL.g:1597:3: (enumLiteral_3= 'or' )
                    // InternalRobotDSL.g:1598:4: enumLiteral_3= 'or'
                    {
                    ...
                    break;
                case 5 :
                    // InternalRobotDSL.g:1605:3: (enumLiteral_4= 'true' )
                    {
                    // InternalRobotDSL.g:1605:3: (enumLiteral_4= 'true' )
                    // InternalRobotDSL.g:1606:4: enumLiteral_4= 'true'
                    {
                    ...
                    break;
                case 6 :
                    // InternalRobotDSL.g:1613:3: (enumLiteral_5= 'false' )
                    {
                    // InternalRobotDSL.g:1613:3: (enumLiteral_5= 'false' )
                    // InternalRobotDSL.g:1614:4: enumLiteral_5= 'false'
                    {
    ...
    public static final BitSet FOLLOW_11 = new BitSet(new long[]{0x0000010000060000L});
    public static final BitSet FOLLOW_12 = new BitSet(new long[]{0x3FC0040000000010L,0x00000000000001F8L});
    public static final BitSet FOLLOW_13 = new BitSet(new long[]{0x3FC0050000040012L,0x00000000000001F8L});
    ...
    public static final BitSet FOLLOW_20 = new BitSet(new long[]{0x3FC0040000040010L,0x00000000000001F8L});
    ...
    public static final BitSet FOLLOW_29 = new BitSet(new long[]{0x3FC0040000000012L,0x00000000000001F8L});
    ...
    public static final BitSet FOLLOW_34 = new BitSet(new long[]{0x0000000000000000L,0x00000000000001F8L});
    public static final BitSet FOLLOW_35 = new BitSet(new long[]{0x0000003000000000L});
    public static final BitSet FOLLOW_36 = new BitSet(new long[]{0xC000000000000000L,0x0000000000000007L});
